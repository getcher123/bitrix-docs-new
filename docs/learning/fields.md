...
| Поле | Описание Тип Обяз. Умолч. | Тип | Обяз. | Умолч. |
| --- | --- | --- | --- | --- |
...
| PREVIEW_PICTURE | Код картинки в [таблице файлов](../main/reference/cfile/index.md) для предварительного просмотра (анонса). | Int |  |  |
...
| PREVIEW_TEXT | Предварительное описание (анонс). | Text |  |  |
| PREVIEW_TEXT_TYPE | Тип предварительного описания (text/html). | String(4) | Да | Text |
| DETAIL_PICTURE | Код картинки в [таблице файлов](../main/reference/cfile/index.md) для детального просмотра. | Int |  |  |
...
| CREATED_BY | [Код пользователя,](../main/reference/cuser/index.md) создавшего урок. | Int | Да | Текущий пользователь |
| ACTIVE | Флаг активности (Y\|N). | Char(1) | Да | Y |
| COURSE_ID | Идентификатор учебного курса. | Int | Да |  |
...
| DESCRIPTION | Описание. | Text |  |  |
| DESCRIPTION_TYPE | Тип описания (text/html). | String(4) | Да | Text |
| FILE_ID | Код картинки/файла в [таблице файлов](../main/reference/cfile/index.md). | Int |  |  |
...
| QUESTIONS_FROM | В тесте участвуют вопросы из: - **A** - со всего курса, - **C** - с каждой главы, - **L** - с каждого урока. | Char(1) | Да | A |
...
| STUDENT_ID | [Код пользователя,](../main/reference/cuser/index.md) проходящего тест. | Int | Да |  |
...
| STUDENT_ID | [Код пользователя](../main/reference/cuser/index.md). | Int | Да |  |
| COURSE_ID | Идентификатор учебного курса. | Int | Да |  |
...
| Поле | Описание Тип Обяз. Умолч. | Тип | Обяз. | Умолч. |
| --- | --- | --- | --- | --- |
| USER_ID | [Код пользователя](../main/reference/cuser/index.md). | Int | Да |  |
