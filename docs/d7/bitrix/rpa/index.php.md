...
Источник: https://dev.1c-bitrix.ru/api_d7/bitrix/rpa/index.php

#### Данные

С точки зрения данных, `rpa` - это те же универсальные списки, только с пользовательскими полями ядра в качестве свойств.

Механизм хранения значений пользовательских свойств похож на такой же в `highloadblock` ([таблицы элементов](https://dev.1c-bitrix.ru/api_d7/bitrix/rpa/item_tables.php)).

В модуле можно создавать процессы и элементы этих процессов.
Каждый процесс имеет набор связанных с ним [пользовательских полей](https://dev.1c-bitrix.ru/api_d7/bitrix/rpa/userfields.php), а также [набор стадий](https://dev.1c-bitrix.ru/api_d7/bitrix/rpa/stages.php).

Почти всё взаимодействие с данными в модуле идёт через orm-объекты:

- [Bitrix\Rpa\Model\Type](https://dev.1c-bitrix.ru/api_d7/bitrix/rpa/lib/model/type.php)
- [Bitrix\Rpa\Model\Stage](https://dev.1c-bitrix.ru/api_d7/bitrix/rpa/lib/model/stage.php)
- [Bitrix\Rpa\Model\Item](https://dev.1c-bitrix.ru/api_d7/bitrix/rpa/lib/model/item.php)
- [Bitrix\Rpa\Model\ItemHistory](https://dev.1c-bitrix.ru/api_d7/bitrix/rpa/lib/model/itemhistory.php)
- [Bitrix\Rpa\Model\Timeline](https://dev.1c-bitrix.ru/api_d7/bitrix/rpa/lib/model/timeline.php)
...
Подробнее про интерфейс `rpa` можно [почитать тут](https://dev.1c-bitrix.ru/api_d7/bitrix/rpa/ui.php).
...
Для этого были сделаны отдельные классы [Director и Scenario](https://dev.1c-bitrix.ru/api_d7/bitrix/rpa/lib/director.php), в которые эта логика, по возможности, вынесена.

Всё остальное настраивается через [роботы и бизнес-процессы](https://dev.1c-bitrix.ru/api_d7/bitrix/rpa/automation.php).
...
Подробнее можно почитать в описании класса [Bitrix\Rpa\UserPermissions](https://dev.1c-bitrix.ru/api_d7/bitrix/rpa/lib/userpermissions.php).
...
Класс [Bitrix\Rpa\UrlManager](https://dev.1c-bitrix.ru/api_d7/bitrix/rpa/lib/urlmanager/parseresult.php) преобразует адреса в имена компонентов и наоборот.
...
Подробнее можно [посмотреть тут](https://dev.1c-bitrix.ru/api_d7/bitrix/rpa/lib/integration/pullmanager.php).
