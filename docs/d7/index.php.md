...
Источник: https://dev.1c-bitrix.ru/api_d7/index.php

**Bitrix Framework** - технологическая платформа для создания и управления проектами (веб-сайтами и корпоративными порталами). На данный момент платформа поддерживает два собственных ядра: старое и новое. Документация по старому ядру размещается [отдельно](../index.md).
...
Документация также доступна в виде файла в формате **chm**: [api_d7.chm](https://dev.1c-bitrix.ru/docs/chm_files/api_d7.chm).
...
![](../../images/d7/dev.1c-bitrix.ru/upload/api_help/example/api_d7_unlock.png)
