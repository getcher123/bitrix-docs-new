...
- [Типовые кейсы использования REST API в CRM и туториалы](https://apidocs.bitrix24.ru/tutorials/crm/index.html)
- [Добавить новый промпт «Анекдот»](https://apidocs.bitrix24.ru/tutorials/ai/add-joke-prompt.html)
...
Пример кода обработчика для события [ONCRMDEALUPDATE](https://apidocs.bitrix24.ru/api-reference/crm/deals/events/on-crm-deal-update.html)
...
Для работы исходящего вебхука убедитесь, что на вашем сервере открыты необходимые [сетевые доступы](https://apidocs.bitrix24.ru/settings/cloud-and-on-premise/network-access.html).

## Продолжите изучение

- [Локальные приложения](local-apps.md)
