...
- [Обзор установки локальных приложений](local-apps/index.md)
- [Обзор установки тиражных приложений](mass-market-apps/index.md)

### Файлы

- [Завершение установки приложений](installation-finish.md)
- [Установка шаблонов сайтов](site-templates-installation.md)
- [Установка решений с "умными сценариями"](smart-scripts-installation.md)
- [Установка отраслевых CRM](vertical-crm-installation.md)
