...
Возвращается true, если в настройках поля Символьный код ![image](../images/5303d0f062.png) (CODE) установлен параметр "Если код задан, то проверять на уникальность". В противном случае возвращается false.
