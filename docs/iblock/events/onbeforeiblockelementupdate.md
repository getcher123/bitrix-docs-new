...
Событие вызывается в методе [CIBlockElement::Update](../classes/ciblockelement/update.md)до изменения элемента информационного блока,
...
Для отмены изменения и прекращении выполнения метода [CIBlockElement::Update](../classes/ciblockelement/update.md)необходимо в функции-обработчике создать исключение методом $APPLICATION-> ThrowException()и вернуть *false*.
---
### Смотрите также


- [Событие "OnAfterIBlockElementUpdate"](onafteriblockelementupdate.md) [CIBlockElement::Update](../classes/ciblockelement/update.md)**Обработка событий**
...
| ![image](../images/7dd82aba60.gif) 10 **Денис Турчин**20.04.2021 07:07:33 |
| --- |
