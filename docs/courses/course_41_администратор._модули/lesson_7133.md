...
Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=41&LESSON_ID=7133
...
1. Создайте **приложение ВКонтакте**. Для этого пройдите по [ссылке](https://id.vk.com/about/business/go) на сайт ВКонтакте.
  **Примечание.** Если вы создаёте приложение впервые, то сначала автоматически запустится мастер создания бизнес-аккаунта. На
  			первом шаге
  ![](../../../images/courses/41/dev.1c-bitrix.ru/images/admin_bisness/integration/VK/account_1.png)
  ...
  ![](../../../images/courses/41/dev.1c-bitrix.ru/images/admin_bisness/integration/VK/account_2.png)
  ...
  Если бизнес-аккаунт уже создан, то при переходе по указанной выше ссылке запустится мастер создания приложений. В этом мастере
  			выберите
  ![](../../../images/courses/41/dev.1c-bitrix.ru/images/admin_expert/social_services/vk/vk_step1.jpg)
  		 в качестве платформы вариант **Web**, а также
  			укажите
  ![](../../../images/courses/41/dev.1c-bitrix.ru/images/admin_expert/social_services/vk/vk_step2.jpg)
  ...
  [![Нажмите на рисунок, чтобы увеличить](../../../images/courses/41/dev.1c-bitrix.ru/images/admin_expert/social_services/vk/vk-keys-sm.jpg)](jav * ascript:ShowImg('/images/admin_expert/social_services/vk/vk-keys.jpg',1300,905,'Настройки приложения ВКонтакте'))
  Чтобы просмотреть защищенный ключ, кликните по
  			значку
  ![](../../../images/courses/41/dev.1c-bitrix.ru/images/admin_expert/social_services/vk/vk_view_key.jpg)
...
2. В настройках модуля **Социальные сервисы** продукта «1С-Битрикс» (Настройки &gt; Настройки продукта &gt; Настройки модулей &gt; Социальные сервисы) отметьте в качестве внешнего сервиса платформу ВКонтакте, а чуть ниже вставьте скопированные ранее **ID приложения** и **Защищенный ключ**:
  ![](../../../images/courses/41/dev.1c-bitrix.ru/images/admin_expert/social_services/vk/vk_settings-params.png)
