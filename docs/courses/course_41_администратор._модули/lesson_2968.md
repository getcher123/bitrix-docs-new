...
- [Следующий: 5242 — Создание комментариев к различным элементам сайта →](lesson_5242.md)

Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=41&LESSON_ID=2968
...
Для использования на форуме фильтра нецензурных слов
			...
			включите данную возможность
                    ...
                    ![](../../../images/courses/41/dev.1c-bitrix.ru/images/admin_expert/forum/v12/forum_set_filter.png)
...
![Нажмите на рисунок, чтобы увеличить](../../../images/courses/41/dev.1c-bitrix.ru/images/admin_expert/forum/v12/dictionary_sm.png)
...
![](../../../images/courses/41/dev.1c-bitrix.ru/images/admin_expert/forum/v12/dictionary_edit.png)
...
Для добавления информации об аналоговом написании букв в словарь транслита используется страница **Словарь транслита** (Сервисы &gt; Форумы &gt; Фильтр нецензурных слов &gt; Словарь транслита &gt; **&lt;имя_словаря&gt;**). Создание
			...
			записи словаря
                    ...
                    ![](../../../images/courses/41/dev.1c-bitrix.ru/images/admin_expert/forum/v12/forum_letter_add.png)
