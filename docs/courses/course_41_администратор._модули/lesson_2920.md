...
Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=41&LESSON_ID=2920
...
- На контроллере и на подключенных сайтах в настройках модуля инфоблоков (по крайней мере, на время) отметьте опцию **Показывать код загрузки из внешних источников**
  ![Показывать код загрузки из внешних источников](../../../images/courses/41/dev.1c-bitrix.ru/images/admin_expert/controller/news_publish_2_11.png)
- Настройте инфоблок на контроллере:
  ...
  ![Настройка инфоблока на контроллере](../../../images/courses/41/dev.1c-bitrix.ru/images/admin_expert/controller/news_publish_1_11.png)
...
- На сайте контроллера добавьте новость
  ![](../../../images/courses/41/dev.1c-bitrix.ru/images/admin_expert/controller/news_publish_9_11.png)
  ![](../../../images/courses/41/dev.1c-bitrix.ru/images/admin_expert/controller/news_publish_10_11.png)
- После чего на подключенном сайте появится новость
  ![](../../../images/courses/41/dev.1c-bitrix.ru/images/admin_expert/controller/news_publish_11.png)
