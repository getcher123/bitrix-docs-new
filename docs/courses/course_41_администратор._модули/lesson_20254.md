...
Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=41&LESSON_ID=20254
...
1. Выполните следующие настройки в модуле Техподдержка:
  ...
  **Результат:**
  ...
  ![](../../../images/courses/41/dev.1c-bitrix.ru/images/admin_expert/support/ex1_access.png)
  После можно установить ответственного по умолчанию на закладке **Настройки**:
  ![](../../../images/courses/41/dev.1c-bitrix.ru/images/admin_expert/support/ex1_defaultuser.png)
...
3. Для высокой критичности обращения установите ответственным Администратора.
  ...
  **Результат:**
  ...
  ![](../../../images/courses/41/dev.1c-bitrix.ru/images/admin_expert/support/ex3_highcrit.png)
