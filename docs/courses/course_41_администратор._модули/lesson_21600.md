...
Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=41&LESSON_ID=21600
...
Для подключения возможности авторизации через сервис дневников (блогов) [www.liveinternet.ru](https://www.liveinternet.ru/) необходимо в настройках модуля **Социальные сервисы** (Настройки &gt; Настройки продукта &gt; Настройки модулей &gt; Социальные сервисы) отметить галочкой опцию Liveinternet и сохранить настройки:
 ...
 ![livi1.png](../../../images/courses/41/dev.1c-bitrix.ru/upload/medialibrary/652/livi1.png)

Сразу после этого при входе на сайт появится логотип ![livi3.png](../../../images/courses/41/dev.1c-bitrix.ru/upload/medialibrary/f4b/livi3.png).
...
![livi2.png](../../../images/courses/41/dev.1c-bitrix.ru/upload/medialibrary/718/livi2.png)
