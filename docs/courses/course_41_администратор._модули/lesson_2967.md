...
Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=41&LESSON_ID=2967
...
1. Перейти в главном меню в 6. Configure pool sites &gt; 4. Change a site's e-mail settings и ввести имя хоста, для которого нужно настроить отправку почты:
  ![](../../../images/courses/41/dev.1c-bitrix.ru/images/bitrixvm/vmbitrix7/manage_sites/vm_email1.png)
2. Далее ввести необходимые данные для почтового сервера:
  ![](../../../images/courses/41/dev.1c-bitrix.ru/images/bitrixvm/vmbitrix7/manage_sites/vm_email22.png)
...
4. Убедиться в правильности введенных данных настройки почтового сервера можно снова в 6. Manage sites in the pool &gt; 4. Change e-mail settings on site:
  ![](../../../images/courses/41/dev.1c-bitrix.ru/images/bitrixvm/vmbitrix7/manage_sites/vm_email33.png)
