...
Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=41&LESSON_ID=9139
...
![](../../../images/courses/41/dev.1c-bitrix.ru/images/admin_expert/highloadblock/hl_import_exist2.png)
...
- **Шаг 3.** Откройте страницу импорта данных в  Highload-блок (Контент &gt; Highload-блоки &gt; Экспорт/импорт &gt; Импорт):
  ![](../../../images/courses/41/dev.1c-bitrix.ru/images/admin_expert/highloadblock/hl_import_exist1.png)
- **Шаг 4.** Укажите параметры импорта:

  - В поле **Файл для импорта** укажите наш файл **color.xml**.
    ![](../../../images/courses/41/dev.1c-bitrix.ru/images/admin_expert/highloadblock/hl_import_files.png)
...
- **Шаг 5.** Запустите процесс импорта. По окончании вы увидите
  			специальное сообщение
                      ![](../../../images/courses/41/dev.1c-bitrix.ru/images/admin_expert/highloadblock/import_ready1.png)
  		.
- **Шаг 6.** Оцените результат импорта. Откройте страницу с записями Highload-блока **ColorReference**.
  ![Нажмите на рисунок, чтобы увеличить](../../../images/courses/41/dev.1c-bitrix.ru/images/admin_expert/highloadblock/import1_records_sm.png)
