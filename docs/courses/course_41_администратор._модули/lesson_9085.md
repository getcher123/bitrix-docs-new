...
Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=41&LESSON_ID=9085
...
- Заполните новые значения в тегах `<item>...</item>`. Например, в файле описание записи выглядит так:
  ...
  ![](../../../images/courses/41/dev.1c-bitrix.ru/images/admin_expert/highloadblock/items_table.png)
...
- Следующая часть файла - это блок с описанием полей Highload-блока, заключенный в теги `<fields>...</fields>`. Опишите каждое поле в `<field>...</field>`:
  ...
  Параметры поля должны быть составлены так, как это требуют
  			пользовательские поля
                      ![Нажмите на рисунок, чтобы увеличить](../../../images/courses/41/dev.1c-bitrix.ru/images/admin_expert/highloadblock/field_4_file_sm.png)
  		.
