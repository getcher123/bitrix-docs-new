...
- [← Предыдущий: 2760 — Видеоматериалы](lesson_2760.md)
- [Следующий: 4972 — Примеры решения типовых задач →](lesson_4972.md)

Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=41&LESSON_ID=26638
