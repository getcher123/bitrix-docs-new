...
- [← Предыдущий: 20212 — Настройки модуля](lesson_20212.md)
- [Следующий: 4996 — Веб-мессенджер: настройки модуля →](lesson_4996.md)

Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=41&LESSON_ID=4562
...
![wiki.png](../../../images/courses/41/dev.1c-bitrix.ru/upload/medialibrary/d9a/wiki.png)
...
На закладке **Социальная сеть**, если планируется использование Wiki в рамках Социальной сети,
			...
			нужно указать
                    ...
                    ![](../../../images/courses/41/dev.1c-bitrix.ru/images/portal_admin/admin_cp/wiki/social_net_11.png)
