...
- [← Предыдущий: 11153 — Возможности модуля](lesson_11153.md)
- [Следующий: 2963 — Группы форумов →](lesson_2963.md)

Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=41&LESSON_ID=2957
...
![Нажмите на рисунок, чтобы увеличить](../../../images/courses/41/dev.1c-bitrix.ru/images/admin_expert/forum/v12/forum_set_sm.png)
...
- выбор галереи смайлов форума (Начиная с версии 15.5.2 модуля **Форум** используются
  ...
  [Подробнее](https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=35&LESSON_ID=3106)...
  		);
...
![Фильтр нецензурных слов](../../../images/courses/41/dev.1c-bitrix.ru/images/admin_expert/forum/v12/forum_set_filter.png)
