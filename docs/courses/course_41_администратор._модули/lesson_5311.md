...
Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=41&LESSON_ID=5311
...
По
			...
			ссылке с идентификатором
                    ...
                    ![](../../../images/courses/41/dev.1c-bitrix.ru/images/admin_expert/ques_answer/form_mail_templ.png)
...
![](../../../images/courses/41/dev.1c-bitrix.ru/images/admin_expert/ques_answer/mail_templ1.png)
...
- Отредактируем текст сообщения, оставив только данные о посетителе и сам вопрос, а также добавим ссылку для перехода к форме ответа на вопрос:
  ![](../../../images/courses/41/dev.1c-bitrix.ru/images/admin_expert/ques_answer/mail_templ2.png)
