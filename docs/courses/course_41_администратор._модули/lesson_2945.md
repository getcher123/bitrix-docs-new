...
- [← Предыдущий: 3523 — Работа с почтовыми шаблонами](lesson_3523.md)
- [Следующий: 2967 — Настройка почты на VMBitrix →](lesson_2967.md)

Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=41&LESSON_ID=2945
