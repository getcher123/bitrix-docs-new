...
Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=41&LESSON_ID=2620

Настройка уровней сервиса выполняется на странице **Уровни техподдержки (SLA)** (Сервисы &gt; Техподдержка &gt; Уровни поддержки):



![SLA](../../../images/courses/41/dev.1c-bitrix.ru/images/admin_expert/support/sla_list.png)
...
- время реакции на обращение пользователя (т.е. время, в течение которого сотрудник службы поддержки должен отреагировать на обращение пользователя);
  ![Время реакции на обращение](../../../images/courses/41/dev.1c-bitrix.ru/images/admin_expert/support/stage_params.png)
...
- группы, пользователи которых имеют право на создание обращений с данным уровнем поддержки;
  ![Настройка прав на SLA](../../../images/courses/41/dev.1c-bitrix.ru/images/admin_expert/support/group_sla.png)
...
- доступные категории и уровни критичности обращений, а также оценки ответов на обращение.
  ...
  ![](../../../images/courses/41/dev.1c-bitrix.ru/images/admin_expert/support/access_sla.png)
- другие параметры.
