...
- [Следующий: 4479 — Основные понятия →](lesson_4479.md)

Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=41&LESSON_ID=20128
...
1. Создайте и настройте блог для менеджера идей c возможностью комментирования. Включите CAPTCHA. Установите права доступа:
  ...
  **Результат:**
  ...
  ![](../../../images/courses/41/dev.1c-bitrix.ru/images/admin_expert/idea/ex_1_set.png)
  Установим права доступа в соответствии с заданием:
  ![](../../../images/courses/41/dev.1c-bitrix.ru/images/admin_expert/idea/ex_1_access.png)
...
2. Настройте возможность голосования за сообщения и комментарии.
  ...
  **Результат:**
  ...
  ![](../../../images/courses/41/dev.1c-bitrix.ru/images/admin_expert/idea/ex_1_set_rating.png)
3. Добавьте новый статус "Обсуждается" (DISCUSSED) и установите его вторым в списке.
  ...
  **Результат:**
  ...
  ![](../../../images/courses/41/dev.1c-bitrix.ru/images/admin_expert/idea/ex_2_list.png)
  Добавим новый статус:
  ![](../../../images/courses/41/dev.1c-bitrix.ru/images/admin_expert/idea/ex_2_newstat.png)
...
- Добавьте категории для идей и разместите компонент Идеи в публичном разделе, указав блог и инфоблок. Теперь проверьте  работу настроек из предыдущих заданий.
  ...
  **Результат:**
  ...
  ![](../../../images/courses/41/dev.1c-bitrix.ru/images/admin_expert/idea/ex_4_status.png)
