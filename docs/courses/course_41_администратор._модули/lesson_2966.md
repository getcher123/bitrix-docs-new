...
Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=41&LESSON_ID=2966
...
![Нажмите на рисунок, чтобы увеличить](../../../images/courses/41/dev.1c-bitrix.ru/images/admin_expert/forum/v12/points2post_sm.png)
...
Для создания новой записи используется кнопка **Новая запись**, расположенная на контекстной панели.  В
			...
			форме создания (редактирования)
                    ...
                    ![Создание (редактирование) записи](../../../images/courses/41/dev.1c-bitrix.ru/images/admin_expert/forum/v12/points2post_edit.png)
...
![Нажмите на рисунок, чтобы увеличить](../../../images/courses/41/dev.1c-bitrix.ru/images/admin_expert/forum/v12/points_admin_sm.png)
...
Для создания новой записи нажмите кнопку **Новое звание**, расположенную на контекстной панели. Откроется
			...
			форма создания (редактирования)
                    ...
                    ![Создание (редактирование) звания](../../../images/courses/41/dev.1c-bitrix.ru/images/admin_expert/forum/v12/points_edit.png)
