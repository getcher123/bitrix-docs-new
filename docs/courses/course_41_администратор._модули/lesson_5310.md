...
Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=41&LESSON_ID=5310
...
Внешний вид формы добавления нового вопроса в систему **Вопрос-ответ** зависит от того, как вы [настроите шаблон](/learning/course/index.php?COURSE_ID=34&LESSON_ID=2928) веб-формы. Пусть шаблон выглядит, например, так:




![](../../../images/courses/41/dev.1c-bitrix.ru/images/admin_expert/ques_answer/form_pub.png)
...
![](../../../images/courses/41/dev.1c-bitrix.ru/images/admin_expert/ques_answer/form_template1.png)
