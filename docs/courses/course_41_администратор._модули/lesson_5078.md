...
Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=41&LESSON_ID=5078
...
2. При регистрации сервера обязательно укажите значение в поле
  ...
  ![](../../../images/courses/41/dev.1c-bitrix.ru/images/portal_admin/system_administration/ldap/ntlm_domen.png)
3. В настройках модуля отметьте опцию
  			Использовать NTLM авторизацию
                      ![](../../../images/courses/41/dev.1c-bitrix.ru/images/portal_admin/system_administration/ldap/ldap_ntlm.png)
