...
Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=41&LESSON_ID=2887
...
- Закладка **Параметры**
  ![Закладка Параметры](../../../images/courses/41/dev.1c-bitrix.ru/images/admin_expert/controller/groups_edit_1_11.png)
...
- Закладка **Модули**
  ![Закладка Модули](../../../images/courses/41/dev.1c-bitrix.ru/images/admin_expert/controller/groups_edit_2_11.png)
