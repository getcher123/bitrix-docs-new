...
Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=41&LESSON_ID=11229
...
1. При выборе сервиса **SMS.RU** на Рабочем столе откроется окно с описанием возможностей SMS маркетинга и формой регистрации в сервисе, в которую необходимо внести
  		...
  		:
  ![Нажмите на рисунок, чтобы увидеть окно с описанием возможностей SMS маркетинга](../../../images/courses/41/dev.1c-bitrix.ru/images/portal_admin/messaging_service/sms_ru_1_.png)
2. Далее нужно
  			ввести проверочный код
  ![](../../../images/courses/41/dev.1c-bitrix.ru/images/portal_admin/messaging_service/sms_ru_2.png)
...
3. Теперь можно
  ...
  ![](../../../images/courses/41/dev.1c-bitrix.ru/images/portal_admin/messaging_service/sms_ru_3.png)
  		 и отправить сообщение на номер, указанный при регистрации.
4. На четвертом этапе выводится сообщение о
  			дальнейших действиях
  ![](../../../images/courses/41/dev.1c-bitrix.ru/images/portal_admin/messaging_service/sms_ru_4.png)
...
![](../../../images/courses/41/dev.1c-bitrix.ru/images/portal_admin/messaging_service/sms_ru_0.png)
