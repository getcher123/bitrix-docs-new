...
Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=41&LESSON_ID=12846
...
1. Создать новое приложение по [ссылке](https://o2.mail.ru/app/new).
  ...
  В поле **Все redirect_uri** внесите
  			адрес
                      ![mailru_2_new.png](../../../images/courses/41/dev.1c-bitrix.ru/upload/medialibrary/198/mailru_2_new.png)
  		 из настроек модуля **Социальные сервисы** (Настройки &gt; Настройки продукта &gt; Настройки модулей &gt; Социальные сервисы):
  ![mailru1.png](../../../images/courses/41/dev.1c-bitrix.ru/upload/medialibrary/225/mailru1.png)
...
3. Нажать кнопку **Подключить сайт**, при необходимости
  			отредактировать приложение
                      ![mailru_4.png](../../../images/courses/41/dev.1c-bitrix.ru/upload/medialibrary/148/mailru_4.png)
  		. Можно отметить, на каких платформах будет установлено ваше приложение,
  			сконфигурировать кнопку входа
                      ![mailru_5.png](../../../images/courses/41/dev.1c-bitrix.ru/upload/medialibrary/4e4/mailru_5.png)
...
4. Указать выданные сервисом
  			ID приложения и Секрет
                      ![mailru2.png](../../../images/courses/41/dev.1c-bitrix.ru/upload/medialibrary/988/mailru2.png)
