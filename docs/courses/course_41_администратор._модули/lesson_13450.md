...
- [Следующий: 3123 — Настройка модуля →](lesson_3123.md)

Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=41&LESSON_ID=13450
...
1. Выполните настройки модуля **Форум**:
  ...
  **Результат:**
  ...
  ![Нажмите на рисунок, чтобы увеличить](../../../images/courses/41/dev.1c-bitrix.ru/images/admin_expert/forum/v12/set_modul_0_sm.png)
  ![Нажмите на рисунок, чтобы увеличить](../../../images/courses/41/dev.1c-bitrix.ru/images/admin_expert/forum/v12/set_modul_1_sm.png)
  ![](../../../images/courses/41/dev.1c-bitrix.ru/images/admin_expert/forum/v12/set_modul_2.png)
