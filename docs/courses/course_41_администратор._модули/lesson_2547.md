...
Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=41&LESSON_ID=2547
...
2. На закладке **Сервер** указываются
  ...
  ![Форма создания новой записи об AD/LDAP сервере](../../../images/courses/41/dev.1c-bitrix.ru/images/portal_admin/system_administration/ldap/ldap_server_param.png)
  ...
  - Кнопка **Проверить** - для проверки введенных выше данных и установления пробного соединения с сервером. Если проверка
    			произведена успешно
                        ![Сообщение об успешном соединении с сервером](../../../images/courses/41/dev.1c-bitrix.ru/images/portal_admin/system_administration/ldap/ldap_edit_good.png)
...
3. На закладке **Настройка полей** указываются значения параметров для схемы данных бюджетов пользователей, хранимых на сервере.
  		 ...
  		 как для **LDAP**, так и для **AD** сервера подставляются в поля формы автоматически.  Выбор типа сервера осуществляется путем нажатия
  			ссылки с соответствующим названием
                      ![](../../../images/courses/41/dev.1c-bitrix.ru/images/portal_admin/system_administration/ldap/ldap_edit_1.png)
  		 в заглавии раздела.
  Если вам необходимо добавить поля в группу
  			Соответствие полей пользователя и атрибутов AD (LDAP)
                      ![](../../../images/courses/41/dev.1c-bitrix.ru/images/portal_admin/admin_sys/ldap/ntlm_fields.png)
  ...
  [Подробнее ...](https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=41&LESSON_ID=2013)
  		.
  ...
  **Отделы и структура компании**
  ...
  ![Значения параметров для LDAP сервера](../../../images/courses/41/dev.1c-bitrix.ru/images/portal_admin/system_administration/ldap/ldap_edit_3.png)
...
4. На закладке **Группы** осуществляется загрузка групп пользователей корпоративной сети и Bitrix Framework в **таблицу соответствий** и задание соответствий этих групп.
  ![Настройка соответствий групп](../../../images/courses/41/dev.1c-bitrix.ru/images/portal_admin/system_administration/ldap/ldap_edit_groups_2_sm.png)

  - Чтобы добавить названия групп пользователей в таблицу, нужно нажать кнопку
    			Обновить список групп
                        ![Настройка соответствий групп](../../../images/courses/41/dev.1c-bitrix.ru/images/portal_admin/system_administration/ldap/ldap_edit_groups.png)
...
5. Периодическая синхронизация баз настраивается на закладке **Синхронизация**:
  ![Настройка синхронизации](../../../images/courses/41/dev.1c-bitrix.ru/images/portal_admin/system_administration/ldap/ldap_sync.png)
