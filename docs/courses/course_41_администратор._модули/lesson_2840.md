...
Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=41&LESSON_ID=2840
...
![Нажмите на рисунок, чтобы увеличить](../../../images/courses/41/dev.1c-bitrix.ru/images/admin_expert/bn/adv_main_set2_sm.png)
...
Предоставление прав доступа к модулю выполняется соответственно на закладке
			...
			Доступ
                    ...
                    ![](../../../images/courses/41/dev.1c-bitrix.ru/images/admin_expert/bn/adv_set_access.png)
