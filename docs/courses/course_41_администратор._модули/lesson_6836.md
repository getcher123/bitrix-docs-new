...
Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=41&LESSON_ID=6836
...
Создайте отдельный [раздел](https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=35&LESSON_ID=2021) `Вопрос - ответ` (имя папки - `/question_answer`) для публичных страниц системы, например, на верхнем уровне, и разместите его в меню:




![](../../../images/courses/41/dev.1c-bitrix.ru/images/admin_expert/forms/41_webforms-6.png)




[Создайте](https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=35&LESSON_ID=2021) в папке `/question_answer` страницы:
