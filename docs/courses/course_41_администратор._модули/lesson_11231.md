...
Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=41&LESSON_ID=11231
...
1. На главной странице [сайта Twilio.com](https://www.twilio.com/) в правом верхнем углу выберем
  			Sign up
  ![](../../../images/courses/41/dev.1c-bitrix.ru/images/portal_admin/messaging_service/twilio.png)
2. Далее необходимо внести свои данные в форму регистрации:
  ![](../../../images/courses/41/dev.1c-bitrix.ru/images/portal_admin/messaging_service/personal_data.png)
  ...
  На этом этапе происходит проверка указанного вами email – на электронную почту будет отправлено
  			письмо.
  ![](../../../images/courses/41/dev.1c-bitrix.ru/images/portal_admin/messaging_service/verify_email.png)
  		 Необходимо перейти по ссылке в письме.
3. На следующем этапе нужно указать
  			телефонный номер,
  ![](../../../images/courses/41/dev.1c-bitrix.ru/images/portal_admin/messaging_service/verify_phone.png)
  ...
  **Примечание:** Этот номер также будет использоваться для аутентификации при входе в Twilio Console. Специалист Twilio onboarding также может использовать этот номер для связи с Вами. Если Вы не хотите, чтобы с вами связывались по этому номеру телефона, отметьте
  ...
  ![](../../../images/courses/41/dev.1c-bitrix.ru/images/portal_admin/messaging_service/verify_phone_2.png)
4. Далее последовательно ответим на вопросы:

  - **Do you write code?** –
    			Yes
    ![](../../../images/courses/41/dev.1c-bitrix.ru/images/portal_admin/messaging_service/twilio_step_1.png)
  - **What is your preferred language?** –
    			PHP
    ![](../../../images/courses/41/dev.1c-bitrix.ru/images/portal_admin/messaging_service/twilio_step_2.png)
  - **What is your goal today?** –
    			Use Twilio in a project
    ![](../../../images/courses/41/dev.1c-bitrix.ru/images/portal_admin/messaging_service/twilio_step_3.png)
  - **What do you want to do first?** –
    			Send or receive a SMS
    ![](../../../images/courses/41/dev.1c-bitrix.ru/images/portal_admin/messaging_service/twilio_step_4.png)
5. Теперь перейдем в раздел Programmable SMS &gt; Learn and Build &gt; Build:
  ![](../../../images/courses/41/dev.1c-bitrix.ru/images/portal_admin/messaging_service/programmable.png)
  ...
  Для продолжения регистрации кликнем ![](../../../images/courses/41/dev.1c-bitrix.ru/images/portal_admin/messaging_service/twilio_0-9_.png)
6. И, наконец,
  			выберем страны
  ![](../../../images/courses/41/dev.1c-bitrix.ru/images/portal_admin/messaging_service/twilio_0-10.png)
...
1. Сначала на сайте **Twilio.com** в разделе **Dashboard** скопируем
  ...
  ![](../../../images/courses/41/dev.1c-bitrix.ru/images/portal_admin/messaging_service/twilio_0-11.png)
2. В настройках модуля **Служба сообщений** (Настройки &gt; Настройки продукта &gt; Настройки модулей &gt; Служба сообщений) кликнем по кнопке
  			Компания Twilio.com.
  ![](../../../images/courses/41/dev.1c-bitrix.ru/images/portal_admin/messaging_service/twilio_settings.png)
  ...
  ![Нажмите на рисунок, чтобы увидеть окно с описанием возможностей SMS маркетинга](../../../images/courses/41/dev.1c-bitrix.ru/images/portal_admin/messaging_service/twilio_1_.png)
3. Если все вышеперечисленные действия выполнены правильно, то в результате Вы увидите
  			соответствующие сообщения.
  ![](../../../images/courses/41/dev.1c-bitrix.ru/images/portal_admin/messaging_service/twilio_1-2.png)
...
![](../../../images/courses/41/dev.1c-bitrix.ru/images/portal_admin/messaging_service/twilio_3.png)
...
![](../../../images/courses/41/dev.1c-bitrix.ru/images/portal_admin/messaging_service/twilio_suspended.png)
...
![](../../../images/courses/41/dev.1c-bitrix.ru/images/portal_admin/messaging_service/twilio_help_1.png)
...
![](../../../images/courses/41/dev.1c-bitrix.ru/images/portal_admin/messaging_service/twilio_help_2.png)
