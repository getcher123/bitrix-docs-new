...
Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=41&LESSON_ID=2886
...
![](../../../images/courses/41/dev.1c-bitrix.ru/images/admin_expert/controller/site_list_controller_11.png)
...
- **Редактировать** – переход к форме редактирования параметров сайта;
  **Примечание:** Для изменения параметров уже подключенного сайта используется  форма схожая с формой
  			Регистрация нового клиента
                      ![Регистрация нового клиента](../../../images/courses/41/dev.1c-bitrix.ru/images/admin_expert/controller/site_list_new_site_11.png)
...
![Закладка Счетчики](../../../images/courses/41/dev.1c-bitrix.ru/images/admin_expert/controller/site_edit_counters_11.png)
...
- Перейдите на страницу настроек **Главного модуля** подчиненного сайта, секция **Служебные процедуры**, закладка **Контроллер**:
  ![Cекция Служебные процедуры](../../../images/courses/41/dev.1c-bitrix.ru/images/admin_expert/controller/main_set_controller_11.png)
...
[Подробнее](https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=35&LESSON_ID=2673&LESSON_PATH=3906.4829.4547.2673#admin)...
