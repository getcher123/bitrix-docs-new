...
Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=41&LESSON_ID=9257
...
- Рассылку можно сделать периодической, установив в поле
  			Отправить рассылку
  ![](../../../images/courses/41/dev.1c-bitrix.ru/images/admin_expert/sender/create_mailing_list_1-4.png)
