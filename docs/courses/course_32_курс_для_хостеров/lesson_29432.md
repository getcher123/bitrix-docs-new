...
- [← Предыдущий: 29430 — Провайдеры](lesson_29430.md)
- [Следующий: 29438 — Как сделать образ BitrixVM для клонирования →](lesson_29438.md)

Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=32&LESSON_ID=29432

Данный скрипт нужен для встраивания [плагинов провайдеров](lesson_29430.md) в web- интерфейс продуктов «1C-Битрикс».
