...
- [← Предыдущий: 3294 — Необходимый уровень прав на сервере](lesson_3294.md)
- [Следующий: 3296 — Ошибки подключения к БД →](lesson_3296.md)

Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=32&LESSON_ID=3295
