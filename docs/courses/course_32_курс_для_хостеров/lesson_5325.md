...
Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=32&LESSON_ID=5325
...
Первое окно информирует о начале работы мастера. Выберите
			...
			шаблон дизайна
                    ...
                    ![](../../../images/courses/32/dev.1c-bitrix.ru/images/admin_start/install/wizzard/v165/estore_step1_sm.png)
...
На этом шаге работы мастера выбирается цветовая тема для выбранного на первом шаге шаблона дизайна сайта. Для разных шаблонов предлагаются разные
			...
			цветовые схемы
                    ...
                    ![](../../../images/courses/32/dev.1c-bitrix.ru/images/admin_start/install/wizzard/v165/estore_step2_sm.png)
...
Задайте
			...
			данные о компании
                    ...
                    ![](../../../images/courses/32/dev.1c-bitrix.ru/images/admin_start/install/wizzard/v165/estore_step3_sm.png)
...
Произведите
			...
			настройки каталога
                    ...
                    ![](../../../images/courses/32/dev.1c-bitrix.ru/images/admin_start/install/wizzard/v165/estore_step4_sm.png)
...
Укажите
			...
			служебные данные
                    ...
                    ![](../../../images/courses/32/dev.1c-bitrix.ru/images/admin_start/install/wizzard/v165/estore_step5_sm.png)
...
Задайте
			...
			типы плательщиков магазина
                    ...
                    ![](../../../images/courses/32/dev.1c-bitrix.ru/images/admin_start/install/wizzard/v165/estore_step6_sm.png)
...
Определите
			...
			способы оплаты, доставки
                    ...
                    ![](../../../images/courses/32/dev.1c-bitrix.ru/images/admin_start/install/wizzard/v165/estore_step7_sm.png)
...
Автоматический шаг, на котором устанавливаются все настройки решения. Отслеживание процесса можно вести по
			...
			графическому индикатору
                    ...
                    ![](../../../images/courses/32/dev.1c-bitrix.ru/images/admin_start/install/wizzard/v165/estore_step8_sm.png)
...
Установка и настройка решения
			...
			завершена
                    ...
                    ![](../../../images/courses/32/dev.1c-bitrix.ru/images/admin_start/install/wizzard/v165/estore_step9_sm.png)
