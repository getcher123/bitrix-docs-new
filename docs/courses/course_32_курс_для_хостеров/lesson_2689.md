...
Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=32&LESSON_ID=2689
...
![](../../../images/courses/32/dev.1c-bitrix.ru/images/install_course/update/main_sysupdate_set.png)
...
- **Установка для разработки** – специальная [опция для разработчиков](/learning/course/index.php?COURSE_ID=135&LESSON_ID=8471), позволяющая устанавливать продукт без блокировки системы обновлений во время разработки.
