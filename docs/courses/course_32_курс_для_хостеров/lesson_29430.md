...
- [← Предыдущий: 29426 — Проксирование запросов](lesson_29426.md)
- [Следующий: 29432 — Скрипт работы с провайдерами →](lesson_29432.md)

Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=32&LESSON_ID=29430
...
**Внимание!** Информацию о работе скрипта, который использует возможности провайдеров и позволяет подключить их в web- интерфейс, см [Скрипт работы с провайдерами](lesson_29432.md).
