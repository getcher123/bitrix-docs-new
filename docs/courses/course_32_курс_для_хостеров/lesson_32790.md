...
- [← Предыдущий: 32788 — Конфигурация Push-server](lesson_32788.md)
- [Следующий: 32620 — Установка и настройка ОС →](lesson_32620.md)

Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=32&LESSON_ID=32790
