...
Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=32&LESSON_ID=31062
...
[назад Конфигурация Push-server](lesson_31060.md)
		                                        [Настройка окружения для Astra Linux 1.8 вперед](/learning/course/index.php?COURSE_ID=32&CHAPTER_ID=031580&LESSON_PATH=3903.4862.20866.31580)
