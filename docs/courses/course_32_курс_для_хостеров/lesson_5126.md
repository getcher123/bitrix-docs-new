...
Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=32&LESSON_ID=5126
...
![Монитор производительности: хиты](../../../images/courses/32/dev.1c-bitrix.ru/images/admin_start/configuration/monitor/perfmon_hit_list_sm.png)
...
Переход по ссылке &gt;&gt; позволяет перейти на желаемую страницу в публичную часть сайта и просмотреть
			...
			детальную статистику
                    ...
                    ![](../../../images/courses/32/dev.1c-bitrix.ru/images/admin_start/configuration/monitor/perfmon_pub_stats_form_a.png)
...
**Примечание:** Нажав кнопку
			...
			Отладка
                    ...
                    ![](../../../images/courses/32/dev.1c-bitrix.ru/images/admin_start/configuration/monitor/but_otladka_menu.png)
		 ...
		 или выбрав пункт меню **Суммарная статистика** (Отладка &gt; Суммарная статистика) на **Панели управления** в публичной части сайта и перейдя по ссылке &gt;&gt; со страницы **Монитор производительности: хиты** (Настройки &gt; Производительность &gt; Хиты), можно просмотреть
			...
			более детальную статистику
                    ...
                    ![](../../../images/courses/32/dev.1c-bitrix.ru/images/admin_start/configuration/monitor/perfmon_pub_stats_form_b.png)
