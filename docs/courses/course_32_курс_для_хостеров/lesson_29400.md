...
Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=32&LESSON_ID=29400
...
Как и в случае [с увеличением свободного места](/learning/course/index.php?COURSE_ID=32&CHAPTER_ID=08883), наиболее простой способ - добавить дополнительный диск и разместить раздел подкачки на нем, либо создать файл подкачки.
