...
Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=32&LESSON_ID=29330
...
[назад Настройки для почтовых сервисов](lesson_29328.md)
		                                        [6. Настройка nginx для работы с композитом (6. Configure nginx to use composite cache) вперед](/learning/course/index.php?COURSE_ID=32&CHAPTER_ID=029338&LESSON_PATH=3903.4862.29228.29318.29338)
