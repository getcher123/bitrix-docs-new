...
Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=32&LESSON_ID=2693
...
- Для установки всех – нажмите кнопку
  			Установить рекомендуемые обновления
                      ![](../../../images/courses/32/dev.1c-bitrix.ru/images/admin_start/install/update/v12/update_go_to_install.png)
  		.
...
![](../../../images/courses/32/dev.1c-bitrix.ru/images/install_course/update/expert_mode.png)




<!-- &lt;p&gt;Если вы выполняете обновление модулей поочередно, а не всех сразу, то после установки каждой «порции» модулей вам необходимо воспользоваться кнопкой &lt;b&gt;Проверить обновления&lt;/b&gt; и затем установить выбранные модули.&lt;/p&gt; -->
...
![](../../../images/courses/32/dev.1c-bitrix.ru/images/admin_start/install/update/error_wrong_code-sm.png)
