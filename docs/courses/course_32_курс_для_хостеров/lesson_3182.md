...
- [Следующий: 4891 — Установка продукта с помощью BitrixSetup →](lesson_4891.md)

Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=32&LESSON_ID=3182
...
1. В
  		...
  		, нажав на кнопку
  			Протестировать новое решение
                      ![](../../../images/courses/32/dev.1c-bitrix.ru/images/content_manager/controls/public_section/hermitage/test_11.png)
...
2. В
  ...
  ![](../../../images/courses/32/dev.1c-bitrix.ru/images/admin_start/install/wizzard/v12/new_solution1_sm_new.png)

- Выбрав подходящее решение из списка в Marketplace, вы перейдете на страницу этого продукта:
  ![](../../../images/courses/32/dev.1c-bitrix.ru/images/admin_start/install/wizzard/v12/new_solution2_sm_new.png)
...
- После выбора вариантов **Тестировать** или **Установить** вы перейдете в раздел **Обновление решений** (Marketplace &gt; Обновление решений). Нажав кнопку
  			Загрузить
                      ![](../../../images/courses/32/dev.1c-bitrix.ru/images/admin_start/install/wizzard/v12/new_solution3_new.png)
  		, необходимо принять лицензионное соглашение, далее начнется загрузка.
- После загрузки решения нажмите кнопку
  			Установить
                      ![](../../../images/courses/32/dev.1c-bitrix.ru/images/admin_start/install/wizzard/v12/new_solution4_new.png)
...
- Установить решение можно и в разделе **Доступные решения** (Marketplace &gt; Установленные решения), выбрав в меню действий пункт
  			Установить
                      ![](../../../images/courses/32/dev.1c-bitrix.ru/images/admin_start/install/wizzard/v12/new_solution5_sm_new.png)
...
![](../../../images/courses/32/dev.1c-bitrix.ru/images/admin_start/install/wizzard/v12/solution_update1_new.png)

По ссылке Посмотреть список обновлений осуществляется переход на закладку

			Список обновлений

                    ![](../../../images/courses/32/dev.1c-bitrix.ru/images/admin_start/install/wizzard/v12/solution_update2.png)
...
![](../../../images/courses/32/dev.1c-bitrix.ru/images/admin_start/install/wizzard/v12/solution_coupon_new.png)
