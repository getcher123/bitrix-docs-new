...
Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=32&LESSON_ID=5130
...
![Монитор производительности: настройки PHP](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_start/configuration/monitor/php_parametrs.png)
...
![Монитор производительности: сервер БД](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_start/configuration/monitor/perfmon_error_list_sm.png)
...
Журнал ошибок PHP ошибок хранится в базе. Удалить журнал ошибок PHP можно с помощью опции
	...
	![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_start/admin_base/tools/setting_error.png)
