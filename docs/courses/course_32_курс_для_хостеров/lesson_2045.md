...
Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=32&LESSON_ID=2045
...
![](../../../images/courses/32/dev.1c-bitrix.ru/images/admin_start/install/master/v125/step5_mysql_sm.png)
...
- Далее выберите **Создать новую базу данных**. Появится дополнительная группа:
  			Пароль и логин администратора базы данных
                      ![](../../../images/courses/32/dev.1c-bitrix.ru/images/admin_start/install/master/v125/step5_mysql_new_sm.png)
  		.
...
![](../../../images/courses/32/dev.1c-bitrix.ru/images/admin_start/install/master/v125/step5_access_sm.png)
