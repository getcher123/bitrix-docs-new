...
- [← Предыдущий: 32928 — Конфигурация Push-server](lesson_32928.md)
- [Следующий: 31040 — Установка и настройка ОС →](lesson_31040.md)

Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=32&LESSON_ID=32946
...
Дистрибутив можно скачать самостоятельно с сайта компании 1С-Битрикс и распаковать его в каталог `/var/www/html/bx-site`.
...
Выполните установку продукта, как описано в главе [Установка продуктов «1С-Битрикс»](https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=32&CHAPTER_ID=04888). На этапе создания базы данных укажите ваши параметры подключения к базе.




![](../../../images/courses/32/dev.1c-bitrix.ru/images/admin_start/install/install_db.png)
