...
Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=32&LESSON_ID=2694
...
- Перейдите на закладку
  			Список обновлений
                      ![](../../../images/courses/32/dev.1c-bitrix.ru/images/admin_start/install/update/v12/update_lang_sm.png)
  		.
