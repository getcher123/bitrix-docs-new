...
- [← Предыдущий: 5050 — Быстрая установка (Short install)](lesson_5050.md)
- [Следующий: 1947 — Регистрация демо-версии коммерческим ключом →](lesson_1947.md)

Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=32&LESSON_ID=1945
...
![](../../../images/courses/32/dev.1c-bitrix.ru/images/admin_start/install/register/v12/reserved_key_sm.png)
...
![](../../../images/courses/32/dev.1c-bitrix.ru/images/admin_start/install/register/add_key.png)

Заполните поля формы для активации ключа:

![Нажмите на рисунок, чтобы увеличить](../../../images/courses/32/dev.1c-bitrix.ru/images/admin_start/install/register/activation_form_sm.png)
...
- Я не зарегистрирован на сайте [www.1с-bitrix.ru](http://www.1c-bitrix.ru) и хочу зарегистрироваться — отметьте, если вы не регистрировались на сайте компании «1С-Битрикс». Откроется форма регистрации, в которой нужно указать имя, фамилию, логин, пароль и email.
  ![Нажмите на рисунок, чтобы увеличить](../../../images/courses/32/dev.1c-bitrix.ru/images/admin_start/install/register/site_reg_sm.png)
...
Вернитесь в административный раздел продукта на страницу *Обновление платформы*. Нажмите
			...
			Зарегистрировать продукт
                    ...
                    ![](../../../images/courses/32/dev.1c-bitrix.ru/images/admin_start/install/register/v12/regdemo4.png)
...
![](../../../images/courses/32/dev.1c-bitrix.ru/images/admin_start/install/register/v12/regdemo5.png)
