...
Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=32&LESSON_ID=31600
...
[назад Конфигурация Push-server](lesson_31598.md)
		                                        [Настройка окружения для SLES 15 вперед](/learning/course/index.php?COURSE_ID=32&CHAPTER_ID=020872&LESSON_PATH=3903.4862.20866.20872)
