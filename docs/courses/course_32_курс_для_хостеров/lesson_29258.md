...
Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=32&LESSON_ID=29258
...
- Менеджер пула запустит задачу обновления Веб-окружения и через некоторое время система обновится до последней версии.
  **Важно!** В процессе обновления версии PHP и MySQL автоматически не обновляются. Обновить их можно в ручном режиме с помощью пункта меню виртуальной машины [1. Manage hosts in the pool - 6. Update PHP and MySQL](/learning/course/index.php?COURSE_ID=32&LESSON_ID=8831).
