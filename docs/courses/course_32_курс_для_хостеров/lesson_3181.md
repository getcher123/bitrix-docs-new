...
Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=32&LESSON_ID=3181
...
![](../../../images/courses/32/dev.1c-bitrix.ru/images/admin_start/install/wizzard/v125/clinic_step0_sm.png)
...
Первое окно информирует о начале работы мастера. Выберите
			...
			шаблон дизайна
                    ...
                    ![](../../../images/courses/32/dev.1c-bitrix.ru/images/admin_start/install/wizzard/v125/clinic_step1_sm.png)
...
Выберите цветовую тему для выбранного на первом шаге шаблона дизайна сайта. Для разных шаблонов предлагаются разные
			...
			цветовые схемы
                    ...
                    ![](../../../images/courses/32/dev.1c-bitrix.ru/images/admin_start/install/wizzard/v125/clinic_step2_sm.png)
...
Задайте данные о компании в
			...
			полях формы
                    ...
                    ![](../../../images/courses/32/dev.1c-bitrix.ru/images/admin_start/install/wizzard/v125/clinic_step3_sm.png)
...
Автоматический шаг, на котором устанавливаются все настройки решения. Отслеживание процесса можно вести по
			...
			графическому индикатору
                    ...
                    ![](../../../images/courses/32/dev.1c-bitrix.ru/images/admin_start/install/wizzard/v125/clinic_step4_sm.png)
...
Установка и настройка решения
			...
			завершена
                    ...
                    ![](../../../images/courses/32/dev.1c-bitrix.ru/images/admin_start/install/wizzard/v125/clinic_step5_sm.png)
