...
Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=32&LESSON_ID=5129
...
![](../../../images/courses/32/dev.1c-bitrix.ru/images/admin_start/configuration/monitor/perfmon_tables_23.png)
...
- Групповые действия
                      ![Групповые действия](../../../images/courses/32/dev.1c-bitrix.ru/images/admin_start/configuration/monitor/perfmon_tables_act_sm.png)
  		 для применения оптимизации или преобразований сразу к нескольким таблицам;
- Фильтры
                      ![](../../../images/courses/32/dev.1c-bitrix.ru/images/admin_start/configuration/monitor/perfmon_tables_filter.png)
...
- Для таблиц модуля **Инфоблоки**, **Поиск** и **Мгновенные сообщения** реализована выборка строк с фильтром по текущему значению в связанных таблицах.
  Поясним на примере. Выберем таблицу **b_search_content** и в контекстном меню конкретной записи (в примере: ID=41) укажем выборку строки
  			из связанной таблицы
                      ![Нажмите на рисунок, чтобы увеличить](../../../images/courses/32/dev.1c-bitrix.ru/images/admin_start/configuration/monitor/search_connected_table_sm.png)
  		 (b_search_content_text). Выполнится выборка тех строк таблицы **b_search_content_text**, где `SEARCH_CONTENT_ID`=41.
  ![Нажмите на рисунок, чтобы увеличить](../../../images/courses/32/dev.1c-bitrix.ru/images/admin_start/configuration/monitor/b_search_content_text_41_sm.png)
- Вывод
  			информации
                      ![](../../../images/courses/32/dev.1c-bitrix.ru/images/admin_start/configuration/monitor/table_id_tooltip.png)
  		, полученной из связанной таблицы (при наведении курсора на значение внешнего ключа).
- По команде
  			Изменить
                      ![](../../../images/courses/32/dev.1c-bitrix.ru/images/admin_start/configuration/monitor/edit_entry_in_table.png)
  		 –
  			редактирование записи и сброс управляемого кеша
                      ![](../../../images/courses/32/dev.1c-bitrix.ru/images/admin_start/configuration/monitor/perfmon_table_3.png)
...
- Создание новых записей
                      ![](../../../images/courses/32/dev.1c-bitrix.ru/images/admin_start/configuration/monitor/add_new_entry.png)
...
>
>
>                     ![](../../../images/courses/32/dev.1c-bitrix.ru/images/admin_start/configuration/monitor/perfmon_table_1.png)
>
>
>
> 		.
