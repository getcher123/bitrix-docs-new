...
Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=34&LESSON_ID=1998
...
2. Настройте его
  			параметры
                      ![](../../../images/courses/34/dev.1c-bitrix.ru/images/admin_start/iblock/rss_import.png)
  		. Обязательно укажите
  			Адрес ленты rss
                      Чтобы получить адрес ленты, на стороннем сайте нажмите кнопку ![](../../../images/courses/34/dev.1c-bitrix.ru/images/content_manager/iblocks/rss_but.png) и скопируйте ссылку в строке браузера.
...
![](../../../images/courses/34/dev.1c-bitrix.ru/images/admin_start/iblock/rss_import_result.png)
