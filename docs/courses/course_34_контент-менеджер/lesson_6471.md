...
- [← Предыдущий: 2123 — Создание фотогалереи](lesson_2123.md)
- [Следующий: 2133 — Перенос фотогалереи на другой сайт →](lesson_2133.md)

Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=34&LESSON_ID=6471
...
[Как создать страницу через публичную часть сайта](lesson_1911.md) (учебный курс «Контент-менеджер»)

[Как создать страницу через административную часть сайта](https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=35&LESSON_ID=2021) (учебный курс «Администратор. Базовый»)
