...
Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=34&LESSON_ID=2935
...
1. **Параметры блога:**
  ...
  **Примечание**: При включении индексации блога не забудьте
  ...
  [Подробнее](https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=35&LESSON_ID=2048) в курсе "Администратор. Базовый"...
  		 модуль.
...
3. **Доп. поля:**
  ...
  [Подробнее](https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=35&LESSON_ID=8637&LESSON_PATH=3906.4493.3874.8637)...
