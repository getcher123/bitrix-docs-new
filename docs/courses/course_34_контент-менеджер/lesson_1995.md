...
Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=34&LESSON_ID=1995
...
1. В настройках типа инфоблоков отметьте опцию
  			Использовать экспорт в RSS
                      ![](../../../images/courses/34/dev.1c-bitrix.ru/images/admin_start/iblock/iblock_types_settings_rss.png)
  		.
2. В настройках модуля **Информационные блоки** (Настройки &gt; Настройки продукта &gt; Настройки модулей &gt; Информационные блоки) укажите
  			путь к директории
                      ![](../../../images/courses/34/dev.1c-bitrix.ru/images/admin_start/iblock/path_to_export_rss.png)
...
1. Создайте страницу и
  			разместите
                      ![](../../../images/courses/34/dev.1c-bitrix.ru/images/admin_start/iblock/iblocks_news_component_new.png)
  		 на ней комплексный компонент **Новости**.
2. Настройте все необходимые параметры: источник данных, настройки RSS и другие:
  ![](../../../images/courses/34/dev.1c-bitrix.ru/images/admin_start/iblock/iblocks_news_component2_new.png)
...
![](../../../images/courses/34/dev.1c-bitrix.ru/images/admin_start/iblock/news_public_new.png)
...
Переход по ссылке **rss** открывает страницу со
			...
			списком элементов
                    ...
                    ![](../../../images/courses/34/dev.1c-bitrix.ru/images/admin_start/iblock/news_rss_export.png)
