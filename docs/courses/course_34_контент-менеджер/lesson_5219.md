...
Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=34&LESSON_ID=5219
...
[Читать подробнее..](/learning/course/index.php?COURSE_ID=41&LESSON_ID=2858)
		 ...
		 **Веб-формы** необходимо снять флаг с поля
			...
			Использовать упрощённый режим редактирования форм
                    ...
                    ![](../../../images/courses/34/dev.1c-bitrix.ru/images/admin_expert/forms/webforms_module_settings_ext.png)
