...
- [← Предыдущий: 16862 — Символьный код](lesson_16862.md)
- [Следующий: 9407 — Свойства элементов →](lesson_9407.md)

Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=34&LESSON_ID=5840
...
- [Настройка SEO информации](lesson_6305.md) в главе **Разделы и элементы** курса Контент-менеджер.
