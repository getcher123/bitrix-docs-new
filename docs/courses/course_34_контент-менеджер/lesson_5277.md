...
- [← Предыдущий: 5139 — Возможности модуля](lesson_5139.md)
- [Следующий: 2980 — Основные понятия →](lesson_2980.md)

Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=34&LESSON_ID=5277

Модерирование форума – одна из задач, которую могут поручить контент-менеджеру. Он должен следить за текстами пользователей: чтобы не было оскорблений, нецензурой лексики и так далее. Для этого ему даются [права](/learning/course/index.php?COURSE_ID=41&LESSON_ID=7360) уровня **модерирование**. Пользователь с правами модератора форума может скрывать\показывать сообщения и темы, переносить их в другие форумы, закрывать\прикреплять темы.
...
- [Назначение модератора форума](https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=41&LESSON_ID=7360) (урок в курсе "Администратор. Модули")
