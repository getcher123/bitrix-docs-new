...
- [← Предыдущий: 2765 — Динамика заполнения веб-форм](lesson_2765.md)
- [Следующий: 2929 — Публикация веб-формы →](lesson_2929.md)

Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=34&LESSON_ID=2928
...
- [Пример для упрощенного режима: анкета регистрации](lesson_12645.md) - практический пример создания веб-формы с собственным шаблоном.
