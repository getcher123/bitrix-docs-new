...
Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=34&LESSON_ID=2000
...
1. Откройте страницу **Загрузка информационного блока** (Контент &gt; Инфоблоки &gt; Импорт &gt; CSV):
  ![Нажмите на рисунок, чтобы увеличить](../../../images/courses/34/dev.1c-bitrix.ru/images/content_manager/iblocks/csv_import_fedit_sm.png)
2. Задайте параметры:
...
3. Укажите
  			формат
                      ![](../../../images/courses/34/dev.1c-bitrix.ru/images/content_manager/iblocks/csv_import_fedit2.png)
  		 вашего файла с данными. Нажмите **Далее**.
4. Задайте
  			соответствия
                      ![](../../../images/courses/34/dev.1c-bitrix.ru/images/admin_start/iblock/import_csv_3.png)
  ...
  **Важно!** Обязательно должно быть выбрано хотя бы одно из полей
  ...
  ![](../../../images/courses/34/dev.1c-bitrix.ru/images/admin_start/iblock/iblock_settings_fields.png)
...
5. Нажмите кнопку **Загрузить данные**. Начинается импорт инфоблока, и в форме отображается ход процесса загрузки. По окончании выводится соответствующее
  			сообщение
                      ![](../../../images/courses/34/dev.1c-bitrix.ru/images/admin_start/iblock/import_csv_4.png)
  		.
