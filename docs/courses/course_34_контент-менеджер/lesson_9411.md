...
- [← Предыдущий: 9407 — Свойства элементов](lesson_9407.md)
- [Следующий: 1912 — Предустановленные данные для полей элементов и разделов →](lesson_1912.md)

Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=34&LESSON_ID=9411
