...
Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=34&LESSON_ID=5154
...
Для создания статусов веб-формы кликните либо на
			...
			Статусы
                    ...
                    ![](../../../images/courses/34/dev.1c-bitrix.ru/images/admin_expert/forms/edit_mode.png)

		 на специальной панели в режиме редактирования нужной веб-формы, либо перейдите по ссылке

			[+]

                    ![](../../../images/courses/34/dev.1c-bitrix.ru/images/admin_expert/forms/webforms_ext_form_status.png)
...
![Нажмите на рисунок, чтобы увеличить](../../../images/courses/34/dev.1c-bitrix.ru/images/admin_expert/forms/add_status_sm.png)
...
- **В очереди**, присваиваемый автоматически
  			всем результатам
                      ![](../../../images/courses/34/dev.1c-bitrix.ru/images/admin_expert/forms/webforms_ext_stat_form_1.png)
  		 после заполнения анкеты. Посетителю, создавшему анкету, дана
  			возможность отредактировать
                       ![](../../../images/courses/34/dev.1c-bitrix.ru/images/admin_expert/forms/access1.png)
  		 анкету, пока она находится в этом статусе.
- **Принято**,
  			устанавливается вручную
                      ![](../../../images/courses/34/dev.1c-bitrix.ru/images/admin_expert/forms/webforms_ext_stat_form_2.png)
  		 контент-менеджером после того, как анкета была рассмотрена и добавлена в банк данных. В данном статусе анкета уже не может быть отредактирована пользователем, отправившим её. Право переводить анкету в статус **Принято** будет предоставлено пользователям группы
  			Редакторы сайта
                      ![](../../../images/courses/34/dev.1c-bitrix.ru/images/admin_expert/forms/access2.png)
  		.
