...
- [← Предыдущий: 11379 — Как создать форму авторизации (регистрации) на простых компонентах](lesson_11379.md)
- [Следующий: 2836 — Подключение CAPTCHA →](lesson_2836.md)

Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=35&LESSON_ID=7174
...
[Подробнее ...](lesson_3092.md)

		.

 

![Нажмите на рисунок, чтобы увеличить](../../../images/courses/35/dev.1c-bitrix.ru/images/admin_start/admin_base/other/captcha_settings_11_new_sm.png)
...
| ![](../../../images/courses/35/dev.1c-bitrix.ru/images/admin_start/admin_base/other/captcha_example_1_new.png) | ![](../../../images/courses/35/dev.1c-bitrix.ru/images/admin_start/admin_base/other/captcha_example_3_new.png) |
| --- | --- |
