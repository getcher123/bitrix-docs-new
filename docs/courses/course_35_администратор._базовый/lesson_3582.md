...
Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=35&LESSON_ID=3582
...
- На странице **Звания** (Сервисы &gt; Форумы &gt; Звания) необходимо
  ...
  [Подробнее ...](http://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=41&LESSON_ID=2966)
...
- Настроим доступ
  ...
  [Подробнее ...](https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=41&LESSON_ID=2964)
  		 к желаемому форуму для созданных ранее групп на странице **Список форумов** (Сервисы &gt; Форумы &gt; Список форумов, закладка **Доступ**)
  			следующим образом
                      ![](../../../images/courses/35/dev.1c-bitrix.ru/images/admin_start/admin_base/ratings/forum_edit_access_11.png)
  		:
...
- Создадим новые правила обработки (Сервисы &gt; Рейтинги &gt; Правила обработки):
  ...
  ![](../../../images/courses/35/dev.1c-bitrix.ru/images/admin_start/admin_base/ratings/rating_rule_new_11.png)
