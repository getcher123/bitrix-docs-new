...
Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=35&LESSON_ID=5127
...
Информация о продукции хранится в инфоблоке, из параметров компонента нам нужно узнать, в каком именно. Для этого, находясь на странице с перечнем наименований товаров,
			...
			откройте на редактирование
                    ...
                    ![](../../../images/courses/35/dev.1c-bitrix.ru/images/content_manager/comp_iblock_edit.png)
...
![Нажмите на рисунок, чтобы увеличить](../../../images/courses/35/dev.1c-bitrix.ru/images/admin_start/admin_base/other/opt_component_11_new_sm.png)
...
![](../../../images/courses/35/dev.1c-bitrix.ru/images/admin_start/admin_base/other/inf_access2_11_new.png)
