...
Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=35&LESSON_ID=2009
...
![Нажмите на рисунок, чтобы увеличить](../../../images/courses/35/dev.1c-bitrix.ru/images/portal_admin/system_administration/users/users_import_11-new-sm.png)
...
![Настройка параметров импорта](../../../images/courses/35/dev.1c-bitrix.ru/images/admin_start/admin_base/user_control/csv_import_11.png)
