...
Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=35&LESSON_ID=4464
...
![Нажмите на рисунок, чтобы увеличить](../../../images/courses/35/dev.1c-bitrix.ru/upload/medialibrary/72d/auto_backup.png)
...
1. Включить или выключить
                      ![](../../../images/courses/35/dev.1c-bitrix.ru/upload/medialibrary/817/auto_backup2.png)
  		 регулярное копирование
2. Указать,
  			где размещать резервную копию
                      ![](../../../images/courses/35/dev.1c-bitrix.ru/upload/medialibrary/c0e/auto_backup3.png)
  		 - локально на сайте, либо [в облаках](lesson_7080.md#backup_cloud): *1С-Битрикс* или в стороннем облаке.
3. Задать
  			расписание копирования
                      ![](../../../images/courses/35/dev.1c-bitrix.ru/upload/medialibrary/04a/auto_backup4.png)
  **Примечание**: минимальная частота создания резервной копии - 1 день.
4. Настроить порядок
  			сохранения или удаления локальных копий
                      ![](../../../images/courses/35/dev.1c-bitrix.ru/upload/medialibrary/8b3/auto_backup5.png)
5. Указать, какие
  			части сайта исключать или включать
                      ![](../../../images/courses/35/dev.1c-bitrix.ru/upload/medialibrary/7a9/auto_backup6.png)
  		 в резервную копию (аналогично настройкам при ручном архивировании)
6. Настроить
  			режим архивации
                      ![](../../../images/courses/35/dev.1c-bitrix.ru/upload/medialibrary/150/auto_backup7.png)
...
7. Выбрать метод запуска резервного копирования. Доступен запуск:
  ![](../../../images/courses/35/dev.1c-bitrix.ru/upload/medialibrary/6d0/auto_backup8.png)
...
![Нажмите на рисунок, чтобы увеличить](../../../images/courses/35/dev.1c-bitrix.ru/upload/medialibrary/9d6/auto_backup10.png)
