...
Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=35&LESSON_ID=5517
...
- Гаджет на рабочем столе вашего сайта
  ![](../../../images/courses/35/dev.1c-bitrix.ru/images/admin_expert/bitrixcloud/monitoring/cloud_monitor_gadget.png)
  Гаджет покажет
  			процент простоев
...
- Страница **Инспектор сайтов** (Настройки &gt; Облако 1С-Битрикс &gt; Инспектор сайтов), на которой отображается детальная информация по всем параметрам инспектирования:
  ![](../../../images/courses/35/dev.1c-bitrix.ru/images/admin_expert/bitrixcloud/monitoring/cloud_monitor_admin_info.png)
- Письма на адрес электронной почты, указанный при [добавлении сайта](#monitor_add) в инспектор:
  ![](../../../images/courses/35/dev.1c-bitrix.ru/images/admin_expert/bitrixcloud/monitoring/cloud_monitor_mail.png)
...
- [Мобильное приложение для администрирования сайтов](http://dev.1c-bitrix.ru/community/blogs/product_features/1cbitrix-administration-is-a-mobile-application-for-order-management.php), в котором можно просматривать статистику инспектора по сайту и получать push-уведомления (с версии модуля **bitrixcloud 14.0.1**).
  ![](../../../images/courses/35/dev.1c-bitrix.ru/images/admin_expert/bitrixcloud/monitoring/cloud_monitor_mobile_1.png) ![](../../../images/courses/35/dev.1c-bitrix.ru/images/admin_expert/bitrixcloud/monitoring/cloud_monitor_mobile_2.png) ![](../../../images/courses/35/dev.1c-bitrix.ru/images/admin_expert/bitrixcloud/monitoring/cloud_monitor_mobile_3.png)
...
2. После чего необходимо перейти на страницу **Инспектор сайтов** (Настройки &gt; Облако 1С-Битрикс &gt; Инспектор сайтов) и с помощью соответствующей кнопки
  			Добавить сайт для инспектирования
                      ![ins_site.png](../../../images/courses/35/dev.1c-bitrix.ru/upload/medialibrary/e2f/ins_site.png)
  		.
  ![](../../../images/courses/35/dev.1c-bitrix.ru/images/admin_expert/bitrixcloud/monitoring/cloud_monitor_add.png)
