...
Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=35&LESSON_ID=5034
...
Для вывода
			...
			формы
                    ...
                    ![](../../../images/courses/35/dev.1c-bitrix.ru/images/admin_expert/security/otp/otp_component_1.png)
...
- В визуальном редакторе добавим компонент **Подключение устройства OTP**:
  ![Нажмите на рисунок, чтобы увеличить](../../../images/courses/35/dev.1c-bitrix.ru/images/admin_expert/security/otp/comp_OTP_in_visual_red_sm.png)
- Добавим в меню личного кабинета пользователя
  			пункт Двухфакторная авторизация
                      ![](../../../images/courses/35/dev.1c-bitrix.ru/images/admin_expert/security/otp/page_with_OTP_in_menu.png)
...
Для вывода
			...
			формы управления резервными кодами
                    ...
                    ![](../../../images/courses/35/dev.1c-bitrix.ru/images/admin_expert/security/otp/otp_component_2.png)
