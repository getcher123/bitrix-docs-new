...
Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=35&LESSON_ID=12984
...
- Откройте файл
                      ![](../../../images/courses/35/dev.1c-bitrix.ru/images/admin_start/admin_base/interface/link_file.png)
...
- В общем списке файлов выберите
  		 ...
  		 **Показать ссылки на файлы без переводов** при помощи кнопки выбора действий. Тогда в списке отобразятся
  			ссылки на файлы
                      Множество цифр синего цвета - это количество ![](../../../images/courses/35/dev.1c-bitrix.ru/images/admin_start/admin_base/interface/links_in_list.png)
...
![](../../../images/courses/35/dev.1c-bitrix.ru/images/admin_start/admin_base/interface/add_pl_phrase.png)

### Режимы просмотра

В правом верхнем углу формы вы найдете переключатель режимов просмотра и редактирования:

![](../../../images/courses/35/dev.1c-bitrix.ru/images/admin_start/admin_base/interface/view_and_edit_modes.png)
...
![Нажмите на рисунок, чтобы увеличить](../../../images/courses/35/dev.1c-bitrix.ru/images/admin_start/admin_base/interface/delete_langmessages_sm.png)
