...
Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=35&LESSON_ID=3375
...
![Нажмите на рисунок, чтобы увеличить](/images/admin_start/configuration/monitor/35_perfmon_pub_stat_sm.png)

**Примечание:**

- Для административной части сайта также доступна **Статистика SQL-запросов**, **Время исполнения страницы**.
  			Отображение статистики
                      ![](../../../images/courses/35/dev.1c-bitrix.ru/images/admin_start/configuration/monitor/perfmon_adm-stats.png)
...
- Информация для опций
                      ![](../../../images/courses/35/dev.1c-bitrix.ru/images/admin_start/configuration/monitor/perfmon_pub_compsress.png)
  		 **Время исполнения страницы** и **Статистика компрессии**
- Информация для опции
  			Статистика SQL-запросов
                      ![](../../../images/courses/35/dev.1c-bitrix.ru/images/admin_start/configuration/monitor/perfmon_sql_pub_all.png)
  		.
...
- При одновременно отмеченных опциях **Время исполнения страницы** и **Статистика SQL-запросов** внизу страницы будет доступна ссылка
  			Время создания страницы
                      ![](../../../images/courses/35/dev.1c-bitrix.ru/images/admin_start/configuration/monitor/perfmon_pub_sqlandtime.png)
...
![](../../../images/courses/35/dev.1c-bitrix.ru/images/admin_start/configuration/monitor/35_perfmon_sql_pub_1.png)
...
![](../../../images/courses/35/dev.1c-bitrix.ru/images/admin_start/configuration/monitor/35_perfmon_sql_pub_2.png)

### Кеш

Данные о кеше выводятся во всплывающем окне:

![](../../../images/courses/35/dev.1c-bitrix.ru/images/admin_start/admin_base/tools/cash_statistic.png)
