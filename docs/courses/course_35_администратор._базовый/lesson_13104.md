...
Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=35&LESSON_ID=13104
...
Для открытия списка оповещений перейдите на страницу **Журнал событий** (Настройки &gt; Инструменты &gt; Журнал событий) и нажмите на кнопку
			...
			Оповещения журнала событий
                    ...
                    ![](../../../images/courses/35/dev.1c-bitrix.ru/upload/medialibrary/599/button_log_notifications.png)

		.

![Нажмите на рисунок, чтобы увеличить](../../../images/courses/35/dev.1c-bitrix.ru/upload/medialibrary/599/log_notifications_sm.png)
...
1. Условия, при которых отправлять оповещения
  ![Нажмите на рисунок, чтобы увеличить](../../../images/courses/35/dev.1c-bitrix.ru/upload/medialibrary/599/log_notification_create_sm.png)
  		:
...
2. Действия для оповещения
                      ![](../../../images/courses/35/dev.1c-bitrix.ru/upload/medialibrary/599/log_notification_create_actions.png)
  		: укажите каким
  			способом
...
Подробнее в курсе [Администратор. Модули](https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=41&LESSON_ID=3523&LESSON_PATH=3911.4558.3523).
...
- [Работа с почтовыми шаблонами](https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=41&LESSON_ID=3523&LESSON_PATH=3911.4558.3523) (курс Администратор. Модули).
