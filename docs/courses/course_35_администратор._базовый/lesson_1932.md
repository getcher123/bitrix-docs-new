...
Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=35&LESSON_ID=1932
...
![](../../../images/courses/35/dev.1c-bitrix.ru/images/content_manager/gif/upload_file_to_folder_upload.gif)
...
Подробнее в курсе [Контент-менеджер](https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=34&LESSON_ID=1853).
		 ...
		 в папку, в которую нужно загрузить файл и нажмите кнопку ![](../../../images/courses/35/dev.1c-bitrix.ru/images/admin_start/admin_base/information/add_files_11.png) на контекстной панели **Менеджера файлов**. Откроется сама форма загрузки файлов:

![Нажмите на рисунок, чтобы увеличить](../../../images/courses/35/dev.1c-bitrix.ru/images/admin_start/admin_base/information/files_upload_form_sm.png)
...
В рамках файловой структуры есть механизм поиска файлов, размещающийся на контекстной панели в виде кнопки
			...
			Поиск
                    ...
                    ![](../../../images/courses/35/dev.1c-bitrix.ru/images/admin_start/admin_base/information/search_button.png)

		. Откроется окно поиска:

 

![](../../../images/courses/35/dev.1c-bitrix.ru/images/content_manager/controls/administrative_section/search_files_11.png)
