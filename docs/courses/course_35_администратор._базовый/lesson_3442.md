...
- [← Предыдущий: 1991 — Управление сайтами и пример создания](lesson_1991.md)
- [Следующий: 8573 — Принципы управления доступом →](lesson_8573.md)

Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=35&LESSON_ID=3442
...
![](../../../images/courses/35/dev.1c-bitrix.ru/images/admin_start/admin_base/del_site.png)
...
![Ошибка при удалении сайта](../../../images/courses/35/dev.1c-bitrix.ru/images/dev_full/multisite/error_deleting_site_11.png)
...
<br>![](../../../images/courses/35/dev.1c-bitrix.ru/images/admin_start/admin_base/catalog_settings.png)
...
2. Вы удаляете сайт, который содержит ядро (к примеру, сайт s1) и на который настроены
  ...
  [Подробнее о настройке симлинков...](https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=103&LESSON_ID=287)
