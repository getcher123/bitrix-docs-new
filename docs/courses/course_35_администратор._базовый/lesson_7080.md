...
Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=35&LESSON_ID=7080
...
![Нажмите на рисунок, чтобы увеличить](../../../images/courses/35/dev.1c-bitrix.ru/upload/medialibrary/704/list.png)
...
![](../../../images/courses/35/dev.1c-bitrix.ru/images/admin_start/install/dump/becup_error.png)
...
![Нажмите на рисунок, чтобы увеличить](../../../images/courses/35/dev.1c-bitrix.ru/upload/medialibrary/e1f/lokal2.png)

В рамках файловой структуры сайта

			файлы копий хранятся

                    ![](../../../images/courses/35/dev.1c-bitrix.ru/upload/medialibrary/450/lokal3.png)
...
Если шифрование включено, то перед началом создания резервной копии появится
			...
			окно для ввода пароля
                    ...
                    ![](../../../images/courses/35/dev.1c-bitrix.ru/images/admin_start/admin_base/tools/rk_5_11_new.png)
