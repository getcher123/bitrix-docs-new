...
Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=35&LESSON_ID=2032
...
![](../../../images/courses/35/dev.1c-bitrix.ru/images/admin_start/install/additional/db_error_report.png)

[Решение проблемы.](https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=32&LESSON_ID=3296)

Ошибки запросов:

![](../../../images/courses/35/dev.1c-bitrix.ru/images/admin_start/install/additional/err1.png)
...
![Отчет о проверке базы данных](../../../images/courses/35/dev.1c-bitrix.ru/upload/medialibrary/b01/proverka.png)
...
![](../../../images/courses/35/dev.1c-bitrix.ru/images/content_manager/optim4_ew.png)
...
По умолчанию значения данных параметров хранятся в файле
			...
			`/bitrix/php_interface/dbconn.php`
                    ...
                    ![optim1.png](../../../images/courses/35/dev.1c-bitrix.ru/upload/medialibrary/3f9/pmp8g0qh9ai6g11cgq64lay4f7bp35fg/optim1.png)
...
Иногда возникает ситуация, когда сайт перестает отвечать и посетителям отображается пустая страница. В этом случае откройте файл `/bitrix/php_interface/dbconn.php`, который содержит параметры соединения с базой данных, и установите значение параметра
			...
			`$DBDebug = true`
                    ...
                    ![optim2.png](../../../images/courses/35/dev.1c-bitrix.ru/upload/medialibrary/94f/re8dyjfbftpdru028mycok8o46lkb8tf/optim2.png)
...
![optim_process.png](../../../images/courses/35/dev.1c-bitrix.ru/upload/medialibrary/396/optim_process.png)

По завершении оптимизации на странице появится

			сообщение об этом

                    ![optim_rez.png](../../../images/courses/35/dev.1c-bitrix.ru/upload/medialibrary/8e8/optim_rez.png)
