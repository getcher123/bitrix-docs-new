...
Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=35&LESSON_ID=6723
...
![](../../../images/courses/35/dev.1c-bitrix.ru/images/admin_expert/scale/scale_new_server2.png)
...
**Внимание!** Если на подключаемом сервере, работающем на одном из специальных [Битрикс VM-решений](http://www.1c-bitrix.ru/products/vmbitrix/), не был сменен пароль по умолчанию для **root**, то
			...
			система предложит это сделать
                    ...
                    ![](../../../images/courses/35/dev.1c-bitrix.ru/images/admin_expert/scale/change_root_pass.png)
