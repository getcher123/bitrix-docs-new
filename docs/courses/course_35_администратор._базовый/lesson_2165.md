...
- [Следующий: 12820 — Проверьте себя →](lesson_12820.md)

Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=35&LESSON_ID=2165
...
- Ошибки поиска элементов инфоблока связаны с неправильно указанным
  			URL'ом страницы детального просмотра элемента
                      ![](../../../images/courses/35/dev.1c-bitrix.ru/images/admin_start/admin_base/search/ib_detail_url.png)
