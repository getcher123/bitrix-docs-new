...
Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=35&LESSON_ID=2071
...
**Примечание**: управление параметрами языков публичного раздела сайта выполняется отдельно для [каждого сайта](lesson_1991.md).
...
1. Создадим учетную запись языка (кнопка
  			Добавить язык
                      ![](../../../images/courses/35/dev.1c-bitrix.ru/images/admin_start/admin_base/interface/add_lang_button.png)
  		 на контекстной панели страницы **Языки интерфейса**).
  ![Добавление языка](../../../images/courses/35/dev.1c-bitrix.ru/upload/medialibrary/77a/langs.png)
...
2. После сохранения запись нового языка будет добавлена в общий список на странице
  			Языки интерфейса
                      ![Список языков](../../../images/courses/35/dev.1c-bitrix.ru/images/admin_start/admin_base/interface/lang_list_11.png)
  		.
3. Также в кнопке для переключения языков на административной панели появится выбор добавленного языка:
  ![](../../../images/courses/35/dev.1c-bitrix.ru/images/admin_start/admin_base/interface/admin_panel_new_lang_11.png)
4. Далее выполните
