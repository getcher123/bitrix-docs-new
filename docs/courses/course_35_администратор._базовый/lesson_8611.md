...
- [Следующий: 12057 — Обработка адресов →](lesson_12057.md)

Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=35&LESSON_ID=8611
...
На закладке **Доп. поля** формы добавления нового пользователя (Настройки &gt; Пользователи &gt; Список пользователей &gt; Добавить пользователя) кликните по
			...
			единственной имеющейся там ссылке
                    ...
                    ![](../../../images/courses/35/dev.1c-bitrix.ru/images/admin_start/examples/typical/add_user_char_11_new.png)
...
**Примечание:** если вкладка **Доп. поля** отсутствует, то выполните
 ...
 В правой части формы нажмите на «шестеренку»  ![](../../../images/courses/35/dev.1c-bitrix.ru/images/admin_start/iblock/set_but.png). Откроется окно с настройками.
...
![](../../../images/courses/35/dev.1c-bitrix.ru/images/admin_start/examples/typical/sky_pe_11_new.png)
...
**Примечание**: если название для языка не заполнено, то вместо названия отобразится **Код поля**. Например, если в нашем примере
			...
			не указать
                    ...
                    ![](../../../images/courses/35/dev.1c-bitrix.ru/images/admin_start/examples/typical/lang_name_userfield.png)

		 название для английского языка, то в форме создания / редактирования пользователя для русского языка отобразится

			Скайп

                    ![](../../../images/courses/35/dev.1c-bitrix.ru/images/admin_start/examples/typical/ru_name_userfield.png)

		, а для английского

			UF_SKYPE

                    ![](../../../images/courses/35/dev.1c-bitrix.ru/images/admin_start/examples/typical/no_en_name_userfield.png)
...
Затем снова перейдите к форме добавления нового пользователя и нажмите кнопку
			...
			**Настроить**
                    ...
                    ![](../../../images/courses/35/dev.1c-bitrix.ru/images/content_manager/controls/public_section/hermitage/button_setting_new.png)
...
[Подробнее ...](https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=34&LESSON_ID=1883)
		 ...
		 из вкладки **Доп. свойства** на вкладку **Личные данные**, т.к. именно на нее необходимо добавить поле **Скайп**. После того, как поле будет перенесено в список выбранных полей, с помощью кнопок **Выше** и **Ниже** выберите его расположение среди других полей секции
			...
			**Телефоны**
                    ...
                    ![](../../../images/courses/35/dev.1c-bitrix.ru/images/portal_admin/typical/add_skype_11_new.png)
...
![](../../../images/courses/35/dev.1c-bitrix.ru/images/portal_admin/typical/new_skype_11_new.png)
