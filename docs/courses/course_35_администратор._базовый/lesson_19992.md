...
Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=35&LESSON_ID=19992
...
В коробочной версии *Битрикс24* есть специальный инструмент - [Мастер очистки данных](https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=48&LESSON_ID=2354&LESSON_PATH=3918.4633.2354).
...
![](../../../images/courses/35/dev.1c-bitrix.ru/images/admin_start/admin_base/other/detail_info_backup.png)
...
![Нажмите на рисунок, чтобы увеличить](../../../images/courses/35/dev.1c-bitrix.ru/images/admin_start/admin_base/other/b_file_sort_sm.png)
...
![Нажмите на рисунок, чтобы увеличить](../../../images/courses/35/dev.1c-bitrix.ru/images/admin_start/admin_base/other/example_research_files_sm.png)
...
![Нажмите на рисунок, чтобы увеличить](../../../images/courses/35/dev.1c-bitrix.ru/images/admin_start/admin_base/other/find_file_from_b_file_sm.png)
...
Подробнее в курсе [Контент-менеджер](https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=34&LESSON_ID=2771#search).
...
Также мы можем посмотреть взаимосвязи с другими таблицами базы данных, для поиска полезной информации. Например, если мы просмотрим связные таблицы, то обнаружим, что наш файл имеет связь с таблицей
			...
			b_iblock_element
                    ...
                    ![](../../../images/courses/35/dev.1c-bitrix.ru/images/admin_start/admin_base/other/link_with_other_table.png)

		. И в ней есть информация об элементе инфоблока, в котором используется это изображение:

![](../../../images/courses/35/dev.1c-bitrix.ru/images/admin_start/admin_base/other/example_research_files_newtable.png)
...
Подробнее об очистке кеша и возможной проблеме с правами описано в отдельном уроке: [Очистка файлов кеша](lesson_2164.md).
...
- Если Вы пользуетесь модулем **Веб-аналитика**, проверьте настройки модуля на закладке **Время хранения**. Большой период времени хранения приводит к увеличению размера базы данных статистики. При необходимости -
  ...
  Подробнее в курсе [Администратор. Модули](https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=41&LESSON_ID=2101)
  		.
