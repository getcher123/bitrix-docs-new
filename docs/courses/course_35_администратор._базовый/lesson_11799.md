...
Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=35&LESSON_ID=11799
...
![adm_menu1.png](../../../images/courses/35/dev.1c-bitrix.ru/upload/medialibrary/dbb/aj4m0pgj3e3jfbzyh1yfuhn6fkuvcrwn/adm_menu1.png)

Добавленные страницы появятся как

			отдельные пункты меню

                    ![](../../../images/courses/35/dev.1c-bitrix.ru/upload/medialibrary/0ca/97vm4o9rzcqux44jg22hc7pzutw0ppmb/adm_menu.png)
...
- При
  			редактировании меню
                      ![red_menu.jpg](../../../images/courses/35/dev.1c-bitrix.ru/upload/medialibrary/8d4/red_menu.jpg)
...
Для создания раздела меню нужно перейти в
			...
			расширенный режим
                    ...
                    ![adm_menu3.png](../../../images/courses/35/dev.1c-bitrix.ru/upload/medialibrary/e45/u594t4oqksfwxhcwyppoxn81plxxmc50/adm_menu3.png)
...
![Нажмите на рисунок, чтобы увеличить](../../../images/courses/35/dev.1c-bitrix.ru/upload/medialibrary/dd2/wpq2yz81cz4t0yhqrpcofum2s4lg113x/adm_menu4_sm.png)
...
Для редактирования кода элемента меню используется кнопка
			...
			Редактировать как файл
                    ...
                    ![edit_as_file.jpg](../../../images/courses/35/dev.1c-bitrix.ru/upload/medialibrary/3e9/edit_as_file.jpg)
...
В результате
			...
			новый раздел добавится в меню
                    ...
                    ![МойРаздел](../../../images/courses/35/dev.1c-bitrix.ru/upload/medialibrary/e07/ltcsaxigcusbwas81o7ypvuzdcrw1ywp/adm_menu5.png)
...
![Нажмите на рисунок, чтобы увеличить](../../../images/courses/35/dev.1c-bitrix.ru/upload/medialibrary/9fa/2z62xgpljugyfxp40co2toi8egl3o8he/adm_menu7_sm.png)
...
В результате
			...
			новый пункт добавится в меню
                    ...
                    ![adm_menu6.png](../../../images/courses/35/dev.1c-bitrix.ru/upload/medialibrary/82a/69bqr9pnx26avs0f90j2xf9to41gbsn1/adm_menu6.png)
