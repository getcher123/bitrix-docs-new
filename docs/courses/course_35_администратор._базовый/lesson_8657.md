...
Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=35&LESSON_ID=8657
...
В публичной части сайта перейдите в раздел **Новости**. Нажмите кнопку **Изменить страницу** и
			...
			откройте в визуальном редакторе
                    ...
                    ![](../../../images/courses/35/dev.1c-bitrix.ru/images/content_manager/gif/component_parameters-vr.gif)
...
![](../../../images/courses/35/dev.1c-bitrix.ru/images/admin_start/admin_base/other/admin_inet_mag_add_11_new.png)
