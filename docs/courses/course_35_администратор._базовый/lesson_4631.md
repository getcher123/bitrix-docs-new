...
- [Следующий: 25250 — Глоссарий →](lesson_25250.md)

Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=35&LESSON_ID=4631
...
[![Нажмите на рисунок, чтобы увеличить](../../../images/courses/35/dev.1c-bitrix.ru/images/admin_start/about/module_list_11_sm.png)](jav * ascript:ShowImg('/images/admin_start/about/module_list_11.png',1038,857,'Добавление приложения'))
...
![Форма настройки параметров модуля](../../../images/courses/35/dev.1c-bitrix.ru/images/admin_start/admin_base/access_control/module_group_edit_11.png)
