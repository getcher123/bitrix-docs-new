...
Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=35&LESSON_ID=3556
...
[Подробнее ...](lesson_2034.md)
		...
		, вы с ним, вероятно, уже знакомы.  Настраивается он на
			...
			одноименной закладке
                    ...
                    ![](../../../images/courses/35/dev.1c-bitrix.ru/images/admin_start/admin_base/security/jornal_events_1_11.png)
...
Для контроля за изменениями в инфоблоках необходимо настроить
			...
			параметры журнала событий
                    ...
                    ![](../../../images/courses/35/dev.1c-bitrix.ru/images/admin_start/admin_base/security/jornal_events_2_11.png)
