...
Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=35&LESSON_ID=8573
...
В [таблице](lesson_6767.md) приведены права доступа по умолчанию к модулям системы для стандартных групп пользователей.
...
![](../../../images/courses/35/dev.1c-bitrix.ru/images/portal_admin/system_administration/basic_administration/information/admin_folder.jpg)
...
- После обновления регламентов "вручную" или через бизнес-процессы ставится задача ИТ службе. Служба исполняет это решение централизовано (
  ...
  [Подробнее](https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=35&CHAPTER_ID=04536&LESSON_PATH=3906.4503.4536)...
