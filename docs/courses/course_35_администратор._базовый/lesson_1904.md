...
- [Следующий: 8571 — Многосайтовость →](lesson_8571.md)

Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=35&LESSON_ID=1904
...
![](../../../images/courses/35/dev.1c-bitrix.ru/upload/learning/21/res22/editing_source_code.png)
...
![](../../../images/courses/35/dev.1c-bitrix.ru/upload/learning/21/res22/php_code_new.png) 

		 ) появится тот же ярлык ![](../../../images/courses/35/dev.1c-bitrix.ru/upload/learning/21/res22/php_icon.png), содержание PHP-кода которого можно будет редактировать в режиме работы с исходным кодом и в области **Свойства**.
