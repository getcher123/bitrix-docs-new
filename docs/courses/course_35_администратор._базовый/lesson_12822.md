...
Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=35&LESSON_ID=12822
...
2. Включите **Защиту административного раздела** (не забудьте добавьте в исключения свой IP-адрес).
  ...
  **Результат:**
  ![Нажмите на рисунок, чтобы увеличить](../../../images/courses/35/dev.1c-bitrix.ru/images/admin_expert/security/administrative_protection-sm.png)
...
3. Включите механизм **двухэтапной авторизации** и настройте её согласно следующим требованиям:
  ...
  **Результат:**
  1. Включаем механизм двухэтапной авторизации (Настройки &gt; Проактивная защита &gt; Двухэтапная авторизация):
    ![](../../../images/courses/35/dev.1c-bitrix.ru/images/admin_expert/security/two-step_authorization.png)
  2. На вкладке **Параметры** указываем нужные настройки:
    ![](../../../images/courses/35/dev.1c-bitrix.ru/images/admin_expert/security/two-step_authorization_settings.png)
...
1. Подключим телефон на странице редактирования своего профиля (Настройки &gt; Пользователи &gt; Список пользователей), вкладка **Двухэтапная авторизация**:
  ![](../../../images/courses/35/dev.1c-bitrix.ru/images/admin_expert/security/two-step_authorization_admin.png)
