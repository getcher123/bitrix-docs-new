...
Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=35&LESSON_ID=2023
...
Самый простой способ открыть форму настройки прав - воспользоваться пунктом **Права на доступ продукта** из контекстного меню для
			...
			файла
                    ...
                    ![](../../../images/courses/35/dev.1c-bitrix.ru/images/admin_start/admin_base/access_control/file_2_edit_access_adm.png)

		 или

			папки

                    ![](../../../images/courses/35/dev.1c-bitrix.ru/images/content_manager/visual_editor/operation_modes/to_edit_page_from_admin_11_1.png)
...
![](../../../images/courses/35/dev.1c-bitrix.ru/images/portal_admin/system_administration/basic_administration/information/edit_perm_custom_11.png)
