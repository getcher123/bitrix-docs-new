...
Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=35&LESSON_ID=6736
...
При наведении указателя мыши на роль всплывет меню, в котором можно
			...
			Добавить роль
                    ...
                    ![](../../../images/courses/35/dev.1c-bitrix.ru/images/admin_expert/scale/add_role1.png)
...
![](../../../images/courses/35/dev.1c-bitrix.ru/images/admin_expert/scale/add_role2.png)

Аналогично можно

			Удалить роль

                    ![](../../../images/courses/35/dev.1c-bitrix.ru/images/admin_expert/scale/del_role1.png)
...
При создании роли **MySQL slave** система
			...
			предложит создать
                    ...
                    ![](../../../images/courses/35/dev.1c-bitrix.ru/images/admin_expert/scale/add_role_mysql1.png)
...
![](../../../images/courses/35/dev.1c-bitrix.ru/images/admin_expert/scale/add_role_mysql2.png)
