...
- [Следующий: 23422 — Назначение прав доступа в интернет-магазине →](lesson_23422.md)

Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=35&LESSON_ID=9411
...
![Нажмите на рисунок, чтобы увеличить](../../../images/courses/35/dev.1c-bitrix.ru/images/content_manager/iblocks/iblock_access_new_sm.png)
...
- Так, контент-редакторам чаще всего предоставляется право
  			Изменение
                      ![](../../../images/courses/35/dev.1c-bitrix.ru/images/content_manager/iblocks/iblock_content_edit.png)
  		, поскольку именно они вносят информацию в инфоблок.
- Для всех пользователей обычно дают право
  			Чтение
                      ![](../../../images/courses/35/dev.1c-bitrix.ru/images/content_manager/iblocks/iblock_all_users.png)
...
**Важно!** При настройке прав доступа помните, что пользователи любых групп обязательно принадлежат и к группе **Все пользователи**. Поэтому право доступа группы **Все пользователи** не должно быть «выше» прав доступа всех остальных групп. В противном случае вы получите
			...
			ошибку
                    ...
                    ![](../../../images/courses/35/dev.1c-bitrix.ru/images/content_manager/iblocks/iblock_group_error.png)
...
![Нажмите на рисунок, чтобы увеличить](../../../images/courses/35/dev.1c-bitrix.ru/images/content_manager/iblocks/iblock_groups_2do_sm.png)
...
![](../../../images/courses/35/dev.1c-bitrix.ru/images/content_manager/iblocks/Iblock_access_ext.png)

По ссылке

			Добавить

                    ![](../../../images/courses/35/dev.1c-bitrix.ru/images/content_manager/iblocks/iblock_add_right.png)
		 ...
		 вы можете выбрать не только группу пользователей, но и группу социальной сети, отдел структуры компании (Битрикс24) или непосредственно отдельных пользователей. Назначение прав выполняется обычным способом — выбором нужного
			...
			уровня доступа из выпадающего списка
                    ...
                    ![](../../../images/courses/35/dev.1c-bitrix.ru/images/content_manager/iblocks/iblock_user_right.png)
