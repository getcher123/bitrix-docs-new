...
Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=35&LESSON_ID=2651
...
- Нажмите кнопку
  			[...]
                      ![](../../../images/courses/35/dev.1c-bitrix.ru/images/admin_start/admin_base/search/iblock_element_search_1.png)
  		 напротив интересующего свойства.
- В открывшейся форме отметьте опцию
  			Значения свойства участвуют в поиске
                      ![](../../../images/courses/35/dev.1c-bitrix.ru/images/admin_start/admin_base/search/iblock_element_search_2.png)
  		.
