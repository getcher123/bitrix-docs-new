...
- [← Предыдущий: 12575 — Регистрация по номеру телефона](lesson_12575.md)
- [Следующий: 11379 — Как создать форму авторизации (регистрации) на простых компонентах →](lesson_11379.md)

Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=35&LESSON_ID=2161
