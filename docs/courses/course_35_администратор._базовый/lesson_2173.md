...
- [← Предыдущий: 2067 — Облако тегов](lesson_2067.md)
- [Следующий: 2651 — Поиск элементов инфоблока по их свойствам →](lesson_2651.md)

Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=35&LESSON_ID=2173
  ...
  **Примечание:** до 11-й версии модуля необходимо использовать другой запрос:
  ...
  В результате на странице будут отражены
  			100 самых популярных
                      ![](../../../images/courses/35/dev.1c-bitrix.ru/images/admin_start/admin_base/search/search_sql_query.png)
  		 терминов на сайте.
