...
Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=35&LESSON_ID=6724
...
В меню
			...
			Глобальные действия
                    ...
                    ![](../../../images/courses/35/dev.1c-bitrix.ru/images/admin_expert/scale/global_menu.png)
...
**Внимание!** Команды могут выполняться довольно длительное время (от одной минуты до 2-3 часов и более) в зависимости от сложности задачи, объема данных, используемых в этих задачах, мощности и загруженности сервера. Во время выполнения команды другой функционал будет недоступен, о чем будет
			...
			выведено сообщение
                    ...
                    ![](../../../images/courses/35/dev.1c-bitrix.ru/images/admin_expert/scale/waiting.png)
...
![Нажмите на рисунок, чтобы увеличить](../../../images/courses/35/dev.1c-bitrix.ru/images/admin_expert/scale/scale_monitoring1_sm.png)
...
Для добавления сайта-ссылки
			...
			нужно ввести
                    ...
                    ![](../../../images/courses/35/dev.1c-bitrix.ru/images/admin_expert/scale/scale_add_site1.png)
...
Для добавления сайта на отдельном ядре нужно ввести
			...
			дополнительные данные
                    ...
                    ![](../../../images/courses/35/dev.1c-bitrix.ru/images/admin_expert/scale/scale_add_site2.png)
...
При удалении нужно
			...
			выбрать сайт
                    ...
                    ![](../../../images/courses/35/dev.1c-bitrix.ru/images/admin_expert/scale/scale_del_site1.png)
...
Для настройки почты
			...
			выберите сайт
                    ...
                    ![](../../../images/courses/35/dev.1c-bitrix.ru/images/admin_expert/scale/scale_config_email1.png)

		 из списка пула и введите необходимые данные для smtp-сервера:

![](../../../images/courses/35/dev.1c-bitrix.ru/images/admin_expert/scale/scale_config_email2.png)
...
Для отключения cron
			...
			выберите сайт
                    ...
                    ![](../../../images/courses/35/dev.1c-bitrix.ru/images/admin_expert/scale/scale_cron_off1.png)
...
По умолчанию доступ к сайтам разрешен по протоколам **http** и **https**. Для отключения протокола **http** просто
			...
			выберите сайт
                    ...
                    ![](../../../images/courses/35/dev.1c-bitrix.ru/images/admin_expert/scale/scale_http_off.png)
...
Для настроек сертификатов выберите
			...
			тип сертификата и сайт
                    ...
                    ![](../../../images/courses/35/dev.1c-bitrix.ru/images/admin_expert/scale/sert_1.png)

		, для которого устанавливается сертификат. Далее введите необходимые данные для

			самоподписного

                    ![](../../../images/courses/35/dev.1c-bitrix.ru/images/admin_expert/scale/sert_self.png)

		 либо

			Let's Encrypt

                    ![](../../../images/courses/35/dev.1c-bitrix.ru/images/admin_expert/scale/sert_encrypt.png)
...
Команды
			...
			обновлений
                    ...
                    ![](../../../images/courses/35/dev.1c-bitrix.ru/images/admin_expert/scale/scale_bitrixenv_update.png)
