...
- [← Предыдущий: 284 — Языковые версии сайта](lesson_284.md)
- [Следующий: 285 — Технология переноса посетителей между сайтами →](lesson_285.md)

Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=103&LESSON_ID=1968
...
![Нажмите на рисунок, чтобы увеличить](../../../images/courses/103/dev.1c-bitrix.ru/upload/medialibrary/62c/rb3hsi3fxe9nwiel1jms0p5ki1qzy2nu/b24com_sm.png)
...
Выбор и настройка параметров языка публичного раздела выполняется отдельно для каждого сайта в
		...
		[Подробнее ...](/learning/course/index.php?COURSE_ID=35&LESSON_ID=2071#local_settings)
...
- [Алгоритм добавления языка](https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=35&LESSON_ID=22790);
- [Языковые версии сайта](lesson_284.md).
