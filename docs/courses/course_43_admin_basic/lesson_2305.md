...
- [← Предыдущий: 2806 — Способы передачи данных между компонентами](lesson_2806.md)
- [Следующий: 2894 — Пример создания компонента →](lesson_2894.md)

Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=43&LESSON_ID=2305
...
Есть ряд исключений для типов данных. Подробнее в уроке [Замечания по $arParams и $arResult](lesson_3043.md).
...
Сначала создайте страницу, например, `/my-page/index.php`. Разместите на странице и настройте новый компонент.
...
3. Переместите компонент *Карточка пользователя* в рабочую область страницы.
  ![](../../../images/courses/43/dev.1c-bitrix.ru/images/dev_full/components/comp_editor_sm.png)
4. Откроется форма с параметрами компонента. Выполните настройки:
  ![](../../../images/courses/43/dev.1c-bitrix.ru/images/dev_full/components/comp_params.png)
...
![](../../../images/courses/43/dev.1c-bitrix.ru/images/dev_full/components/comp_pub.png)
