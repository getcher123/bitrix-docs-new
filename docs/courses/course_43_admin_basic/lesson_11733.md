...
- [← Предыдущий: 11741 — N:M](lesson_11741.md)
- [Следующий: 11715 — Обратная совместимость →](lesson_11715.md)

Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=43&LESSON_ID=11733
...
**Примечание:** перед использованием [CLI-окружения](lesson_11685.md) убедитесь, что установили зависимости проекта через [composer](lesson_4637.md).
