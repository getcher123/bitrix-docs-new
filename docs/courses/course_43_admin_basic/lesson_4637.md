...
- [← Предыдущий: 2705 — Папка /local](lesson_2705.md)
- [Следующий: 11685 — Bitrix CLI →](lesson_11685.md)

Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=43&LESSON_ID=4637

Тему урока можно изучить в новом формате — [в документации по Bitrix Framework](https://docs.1c-bitrix.ru/pages/get-started/composer.html). В ней улучшена структура, описание, примеры.
