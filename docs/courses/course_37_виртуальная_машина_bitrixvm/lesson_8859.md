...
- [← Предыдущий: 8857 — 6. Настройка резервного копирования сайта (6. Change backup settings on site)](lesson_8857.md)
- [Следующий: 8861 — 8. Настройка xmppd|smtpd сервисов для сайта (8. Configure optional services (xmppd|smtpd) for site) →](lesson_8861.md)

Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=37&LESSON_ID=8859
...
Более подробно ознакомиться с работой механизма можно в уроке [NTLM-авторизация в стороннем окружении](https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=35&LESSON_ID=23106) курса Администратор. Базовый.
...
### пользователей в «Битрикс24 в коробке»
...
### пользователей в «1С-Битрикс: Виртуальная машина»
