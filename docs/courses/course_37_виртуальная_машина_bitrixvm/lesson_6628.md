...
- [← Предыдущий: 6629 — Провайдеры](lesson_6629.md)
- [Следующий: 2713 — Введение →](lesson_2713.md)

Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=37&LESSON_ID=6628

Данный скрипт нужен для встраивания [плагинов провайдеров](lesson_6629.md) в web- интерфейс продуктов «1C-Битрикс».
