...
- [← Предыдущий: 7348 — Настройка xmppd|smtpd сервисов для сайта (Configure optional services (xmppd|smtpd) for site)](lesson_7348.md)
- [Следующий: 3086 — Конфигурационный файл сайта →](lesson_3086.md)

Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=37&LESSON_ID=3085
