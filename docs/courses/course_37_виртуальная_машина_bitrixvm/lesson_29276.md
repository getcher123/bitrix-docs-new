...
Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=37&LESSON_ID=29276
...
- Выбрать сетевой интерфейс (в данном примере это **eth0**) и он будет автоматически сконфигурирован:
  ![](../../../images/courses/37/dev.1c-bitrix.ru/images/bitrixvm/vmbitrix9/menu_bitrixv/configure_network_dhcp.png)
