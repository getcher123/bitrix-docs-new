...
- [← Предыдущий: 29284 — 6. Обновление локального сервера (6. Update server)](lesson_29284.md)
- [Следующий: 29292 — 2. Изменить пароль пользователя root для MySQL (2. Change password for MySQL root user) →](lesson_29292.md)

Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=37&LESSON_ID=29290
...
![Нажмите на рисунок, чтобы увеличить](../../../images/courses/37/dev.1c-bitrix.ru/images/bitrixvm/vmbitrix9/menu_bitrixv/update_mysql_settings_sm.png)
