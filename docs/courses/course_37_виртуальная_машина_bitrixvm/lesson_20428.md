...
- [← Предыдущий: 30542 — Веб-кластер: конфигурация, бэкапы, восстановление](lesson_30542.md)
- [Следующий: 6489 — Установка «1С-Битрикс: Веб-окружение» - Linux 5.x →](lesson_6489.md)

Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=37&LESSON_ID=20428
