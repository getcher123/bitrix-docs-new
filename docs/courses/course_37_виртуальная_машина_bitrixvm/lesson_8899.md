...
- [← Предыдущий: 8897 — Выполнение всех агентов на Cron](lesson_8897.md)
- [Следующий: 8901 — Подключение IDE →](lesson_8901.md)

Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=37&LESSON_ID=8899
