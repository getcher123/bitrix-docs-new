...
Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=37&LESSON_ID=29234
...
2. Загрузите скрипт *«1С-Битрикс: Веб-окружение» — Linux* и запустите его командами:
  ...
  /root/menu.sh
  ```
  В *VMBitrix* **версии 9x+** нужно обязательно создать пул ([1. Create Management pool of server](https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=37&CHAPTER_ID=029250)). Мастер создания пула откроет все необходимые порты в CentOS для корректной работы сервисов продуктов «1С-Битрикс»:
  - 22 — ssh доступ
  ...
  После создания, обязательно подключите Push ([6. Configure Push/RTC service for the pool](https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=37&CHAPTER_ID=029374)). В версии виртуальной машины 9x+ сервис автоматически не подключается.
