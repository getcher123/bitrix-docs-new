...
- [← Предыдущий: 8887 — Увеличение размера существующего жесткого диска BitrixVM](lesson_8887.md)
- [Следующий: 8889 — Подключение Swap-раздела →](lesson_8889.md)

Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=37&LESSON_ID=9383
...
Пусть размер системного диска был увеличен с 20 ГБ до 100Гб, как было [сделано ранее](lesson_8887.md) в VMWare или VirtualBox (пункт 1).
...
1. Смотрим, что в системе на данный момент есть из устройств/разделов командой:
  ...
  fdisk -l
  ```
  ![](../../../images/courses/37/dev.1c-bitrix.ru/images/bitrixvm/vmbitrix75/other_options/vm_disk_increase1.png)
2. Убеждаемся, что место в системе автоматически не увеличилось при помощи команды:
  ```
  df -h
  ```
  ![](../../../images/courses/37/dev.1c-bitrix.ru/images/bitrixvm/vmbitrix75/other_options/vm_disk_increase2.png)
...
4. Далее командой **n** создаем новый раздел:
  ...
  - Раздел **sda3** создан. Для сохранения обновленной таблицы разделов и выхода из fdisk – команда **w**.
    ![](../../../images/courses/37/dev.1c-bitrix.ru/images/bitrixvm/vmbitrix75/other_options/vm_disk_increase3.png)
...
9. Сканируем диски на предмет наличия групп томов и активируем все найденные группы томов:
  ...
  vgchange -ay
  ```
  ![](../../../images/courses/37/dev.1c-bitrix.ru/images/bitrixvm/vmbitrix75/other_options/vm_disk_increase4.png)
10. Узнаем тип файловой системы:
  ```
  file -s /dev/sda1
  ```
  ![](../../../images/courses/37/dev.1c-bitrix.ru/images/bitrixvm/vmbitrix75/other_options/vm_disk_increase5.png)
...
11. И наконец, расширяем файловую систему XFS (может потребоваться время):
  ...
  ```
  ![](../../../images/courses/37/dev.1c-bitrix.ru/images/bitrixvm/vmbitrix75/other_options/vm_disk_increase6.png)
...
12. Проверяем итоговый результат:
  ...
  df -h
  ```
  ![](../../../images/courses/37/dev.1c-bitrix.ru/images/bitrixvm/vmbitrix75/other_options/vm_disk_increase7.png)
