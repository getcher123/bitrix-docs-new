...
- [← Предыдущий: 2501 — Импорт из 1С: Зарплата и управление персоналом](lesson_2501.md)
- [Следующий: 14172 — Контроль слабых паролей →](lesson_14172.md)

Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=48&LESSON_ID=3081
...
![](../../../images/courses/48/dev.1c-bitrix.ru/images/content_manager/gif/open_main_module_settings.gif)

		 на закладке **Авторизация**:

![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_start/admin_base/security/psevdo_ssl_1_11.png)
