...
Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=48&LESSON_ID=2625
...
![Список обращений](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_expert/support/ticket_list.png)
...
![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_expert/support/ticket_edit.png)
...
![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_expert/support/discuss_ticket.png)
...
![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_expert/support/support_settings.png)
...
![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_expert/support/answet_mode_button.png)
...
![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_expert/support/support_ticket_user_use.png)
...
![](../../../images/courses/48/dev.1c-bitrix.ru/images/portal_admin/system_administration/support/support_view.gif) - режим просмотра;
![](../../../images/courses/48/dev.1c-bitrix.ru/images/portal_admin/system_administration/support/support_write.gif) - режим ответа.
...
![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_expert/support/support_settings1.png)



Иконка ![](../../../images/courses/48/dev.1c-bitrix.ru/images/portal_admin/system_administration/support/support_refresh.gif) позволяет обновить список пользователей, просматривающих сообщение в данный момент, вручную.
...
![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_expert/support/support_ticket_time.png)
...
- Определить статус, критичность, сложность, категорию, уровень поддержки для обращения, а также назначить сотрудника, ответственного за решение проблемы.
  **Примечание**: при изменении уровня поддержки или категории, в качестве сотрудника, ответственного за решение проблемы, может быть назначен сотрудник, установленный в параметрах категории или уровня поддержки по умолчанию. Для этого служит иконка ![](../../../images/courses/48/dev.1c-bitrix.ru/images/portal_admin/system_administration/support/resp.gif), расположенная рядом с соответствующим полем.
- Если ответ на обращение не может быть дан в ближайшее время либо необходимо поддерживать его актуальность, то сообщение может быть сохранено в качестве
  			отложенного.
  ![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_expert/support/support_ticket_prolong.png)
...
- Для того чтобы закрыть сообщение, следует установить флаг в поле
  			Закрыть сообщение.
  ![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_expert/support/support_ticket_close.png)
- Использование поля
  			Закрыть при отсутствии ответа через
  ![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_expert/support/support_ticket_close_day.png)
  ...
  **Примечание**: значение поля **Закрыть при отсутствии ответа через** по умолчанию задается на странице настроек модуля **Техподдержка**:
  ![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_expert/support/support_settings2.png)
