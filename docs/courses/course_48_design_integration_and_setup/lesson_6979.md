...
Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=48&LESSON_ID=6979

Понадобилось восстановить сайт или отдельные файлы? Регулярно создавайте резервные копии, чтобы у вас всегда был под рукой свежий бекап ![](../../../images/courses/48/dev.1c-bitrix.ru/bitrix/images/main/smiles/3/bx_smile_wink.png). А как восстановить сайт, расскажем в уроке.
...
![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_start/install/dump/restore_button_in_list.png)
...
- Для локальной копии отобразится окно с
  			именем архива
                      ![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_start/install/dump/restore_local_backup.png)
  		. При нажатии кнопки **Далее** сразу начнется
  			распаковка архива
                      ![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_start/admin_base/tools/recover/recover_adm3_sm.png)
  		;
...
- Для облачной копии *1С-Битрикс* откроется окно с тремя вариантами выбора:
  ![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_start/install/dump/restore_cloud_backup.png)
  ...
  - Скачать резервную копию с другого сайта. Вы можете указать
    			ссылку
                        ![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_start/install/dump/restore_local_backup_link.png)
    		 на резервную копию с любого другого ресурса. Например, это может быть ссылка на локальный бекап с сайта на *1С-Битрикс*, полученная через меню в
    			списке резервных копий
                        ![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_start/install/dump/local_backup_link.png)
    		;
...
- **Восстановление базы данных**:
  ![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_start/admin_base/tools/recover/recover_adm4_sm.png)
...
- После успешного восстановления базы данных в целях безопасности необходимо **Удалить локальную резервную копию и служебные скрипты**, нажав на одноименную кнопку:
  ![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_start/admin_base/tools/recover/recover_adm5_sm.png)
- Восстановление
  			завершено
                       ![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_start/admin_base/tools/recover/recover_adm6_sm.png)
  		.
...
![err.png](../../../images/courses/48/dev.1c-bitrix.ru/upload/medialibrary/f53/err.png).
