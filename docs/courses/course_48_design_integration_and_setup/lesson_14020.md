...
Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=48&LESSON_ID=14020
...
![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_start/admin_base/tools/config_test_11_new.png)

Каждый тест сопровождается подробной информацией, которую можно прочитать по кнопке ![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_start/admin_base/tools/test_info_btn.png) в строке теста. Откроется окно с

			подробными комментариями


	![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_start/admin_base/tools/test_info_11_sm.png)
...
![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_start/admin_base/tools/test_access_11_new.png)
