...
Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=48&LESSON_ID=2056
...
![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_start/admin_base/search_morph_choose.png)
...
Ручная настройка поискового механизма **Sphinx** описана в данном [уроке](/learning/course/index.php?COURSE_ID=48&LESSON_ID=5935).
...
Если вам подходит обычный поиск (**Bitrix**), то в настройках параметров морфологии вам будет доступен параметр
			...
			Cимволы, по которым не производится разделение документа на слова (при морфологическом анализе)
                    ...
                    ![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_start/admin_base/search/search_morph_bitrix.png)
