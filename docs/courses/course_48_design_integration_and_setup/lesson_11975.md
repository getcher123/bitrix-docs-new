...
- [Следующий: 15306 — Перенос сайта24 в Битрикс24 →](lesson_15306.md)

Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=48&LESSON_ID=11975
...
Например, давайте разместим в блоке
 ...
 ![komp.png](../../../images/courses/48/dev.1c-bitrix.ru/upload/medialibrary/4cf/komp.png)
...
3. Создаем файл `.description.php`. Это и есть "обертка" - файл манифеста. Открываем его на редактирование
  			как PHP
                      ![](../../../images/courses/48/dev.1c-bitrix.ru/upload/medialibrary/38b/edit_php.png)
...
4. Очищаем кэш с помощью кода и
  			выполнения php-команды
                      ![php_string.png](../../../images/courses/48/dev.1c-bitrix.ru/upload/medialibrary/ed8/php_string.png)
  		:
  ```
  ...
  ```
5. Создаем страницу
                       ![new_site.png](../../../images/courses/48/dev.1c-bitrix.ru/upload/medialibrary/61c/new_site.png)
  		 в разделе **Сайты 24**.
6. Проверяем, появился ли наш блок в
  			списке блоков
                      ![add_block.png](../../../images/courses/48/dev.1c-bitrix.ru/upload/medialibrary/38b/add_block.png)
