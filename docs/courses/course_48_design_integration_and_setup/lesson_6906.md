...
Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=48&LESSON_ID=6906
...
Сами идеи, как и комментарии к ним, функционируют на основе
 ...
 [Подробнее...](https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=34&CHAPTER_ID=04477&LESSON_PATH=3905.4477)
		...
		. Поэтому необходимо сначала создать соответствующий [блог](lesson_2935.md), а далее создать [инфоблок](/learning/course/index.php?COURSE_ID=34&CHAPTER_ID=02011&LESSON_PATH=3905.4477.2011) и подключить в публичной части [компонент](/learning/course/index.php?COURSE_ID=34&LESSON_ID=4695).
...
- Если комментирование будущих Идей разрешается, то:
  ...
  Конкретную же группу лиц, имеющих право модерировать сервис, указывает Контент-менеджер в настройках комплексного компонента идей (**bitrix:idea**) в параметре
  			Группы пользователей, которые могут добавлять специальный ответ
                       ![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_expert/idea/blog_idea_component_right.png)
  Чтобы пользователи смогли голосовать за идеи, необходимо в административной части (Сервисы &gt; Рейтинги &gt; Список рейтингов, Рейтинг) во вкладке **Блог** отметить
  			пункты
                      ![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_expert/idea/blog_idea_rating_setting.png)
  		:
  ...
  - на закладке
    			Параметры блога
                         ![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_expert/idea/blog_idea_comment.png)
  ...
  - на закладке
    ...
    ![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_expert/idea/blog_idea_rights.png)
