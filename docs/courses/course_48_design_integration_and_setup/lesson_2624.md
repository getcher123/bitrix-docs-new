...
Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=48&LESSON_ID=2624
...
![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_expert/support/support_tickets_list.png)




  ![](../../../images/courses/48/dev.1c-bitrix.ru/images/portal_admin/system_administration/support/support_indicator_red.gif) – последний раз в обращение писал клиент техподдержки (вы ответственный);
  ![](../../../images/courses/48/dev.1c-bitrix.ru/images/portal_admin/system_administration/support/support_indicator_yellow.gif) – последний раз в обращение писал клиент техподдержки (вы не ответственный);
  ![](../../../images/courses/48/dev.1c-bitrix.ru/images/portal_admin/system_administration/support/support_indicator_green.gif) – последний раз в обращение писали вы;
  ![](../../../images/courses/48/dev.1c-bitrix.ru/images/portal_admin/system_administration/support/support_indicator_green_s.gif) – последний раз в обращение писал сотрудник техподдержки;
  ![](../../../images/courses/48/dev.1c-bitrix.ru/images/portal_admin/system_administration/support/support_indicator_grey.gif) – обращение закрыто.
