...
- [Следующий: 10259 — Что ищется? →](lesson_10259.md)

Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=48&LESSON_ID=2048
...
![Переиндексация сайта](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_start/admin_base/search/reindex.png)
...
- Нажмите кнопку **Индексация** на панели управления (**Режим правки** должен быть включен):
  ![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_start/admin_base/search/reindex_socnet.png)
