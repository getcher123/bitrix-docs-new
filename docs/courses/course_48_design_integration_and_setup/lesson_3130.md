...
Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=48&LESSON_ID=3130
...
![Нажмите на рисунок, чтобы увеличить](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_expert/workflow/options1_sm.png)
...
На закладке **Доступ** настраиваются
			...
			уровни прав доступа
                    ...
                    ![Настройки модуля Документооборот](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_expert/workflow/options2.png)
