...
- [← Предыдущий: 4619 — Проверка работы](lesson_4619.md)
- [Следующий: 11233 — Настройка модуля →](lesson_11233.md)

Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=48&LESSON_ID=11141
...
![Нажмите на рисунок, чтобы увидеть полное изображение](../../../images/courses/48/dev.1c-bitrix.ru/images/portal_admin/messaging_service/dispatch_sm.png)
