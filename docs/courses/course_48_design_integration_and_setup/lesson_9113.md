...
Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=48&LESSON_ID=9113
...
![Нажмите на рисунок, чтобы увеличить](../../../images/courses/48/dev.1c-bitrix.ru/images/portal_admin/admin_cp/protect_settings_sm.png)
  ...
  **Внимание**! Удалите файл-флажок сразу как будут решены проблемы с доступом. В настройках модуля **Проактивная защита** и в
  ...
  [Подробнее](lesson_2675.md)...
  		 появится соответствующее
  			предупреждение
                      ![](../../../images/courses/48/dev.1c-bitrix.ru/images/portal_admin/admin_cp/file_flag_warning.png)
  		.
