...
Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=48&LESSON_ID=7285
...
Для Одноклассников необходимо указать в
			...
			настройках
                    ...
                    ![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_expert/social_services/ok/options_ok1.png)
...
2. Добавить приложение
                      ![add_odn.png](../../../images/courses/48/dev.1c-bitrix.ru/upload/medialibrary/7b7/add_odn.png)
...
4. Нажать кнопку **Добавить платформу** и выбрать
  			OAuth
                      ![ok3.png](../../../images/courses/48/dev.1c-bitrix.ru/upload/medialibrary/d4e/ok3.png)
  		. На странице появится дополнительный раздел
  			Настройки внешнего приложения
                      ![ok2.png](../../../images/courses/48/dev.1c-bitrix.ru/upload/medialibrary/74f/ok2.png)
...
5. После нажатия кнопки **Сохранить** на почту, указанную в аккаунте разработчика, придет
  			письмо с данными
                      ![ok4.png](../../../images/courses/48/dev.1c-bitrix.ru/upload/medialibrary/f63/ok4.png)
