...
Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=48&LESSON_ID=5801
...
- Для начала проверяем, как его обработает *Internet Explorer 10* с включенным **mime-сниффингом**:
  ...
  ![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_expert/security/security_scanner_ex_1.png)
- А теперь с заголовком `X-Content-Type-Options: nosniff`.
  ...
  ![2013_10_27_152255.png](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_expert/security/security_scanner_ex_2.png)
