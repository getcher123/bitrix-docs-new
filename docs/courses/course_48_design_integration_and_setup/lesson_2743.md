...
Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=48&LESSON_ID=2743
...
- [CDN](/learning/course/index.php?COURSE_ID=48&LESSON_ID=11775).
  			Раздача статического контента
                      ![](../../../images/courses/48/dev.1c-bitrix.ru/upload/medialibrary/4c2/cloud.png)
...
- [Работа с резервными копиями](lesson_7080.md#backup_cloud).
  			Создание и просмотр резервных копий
                      ![](../../../images/courses/48/dev.1c-bitrix.ru/upload/medialibrary/5b5/cloud2.png)
...
1. **Резервные копии** - на странице Настройки &gt; Облако 1С-Битрикс &gt; Резервные копии находится список облачных резервных копий (хранящихся в облаке 1С-Битрикс).
  ...
  | ![Нажмите на рисунок, чтобы увеличить](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_start/admin_base/bitrix_cloud/cloud_backups2_sm.png) |  |
  | --- | --- |
  | ![Нажмите на рисунок, чтобы увеличить](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_start/admin_base/bitrix_cloud/make_cloud_backup2_sm.png) | ![Нажмите на рисунок, чтобы увеличить](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_start/admin_base/bitrix_cloud/all_backups2_sm.png) |
...
2. **Расписание резервирования** - на странице Настройки &gt; Облако 1С-Битрикс &gt; Расписание резервирования выведена информация о расписании регулярного резервного копирования в облако 1С-Битрикс.
  ...
  | ![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_start/admin_base/bitrix_cloud/admin_menu_backups.png)
  <br><!-- &lt;a href="javascript:ShowImg('/images/admin_start/admin_base/bitrix_cloud/cloud_backups.png',1010,608,'Резервное копирование')"&gt;&lt;img alt="Нажмите на рисунок, чтобы увеличить" src="/images/admin_start/admin_base/bitrix_cloud/cloud_backups2_sm.png" title="Резервное копирование" style="cursor: pointer;"&gt;&lt;/a&gt; --> | ![Нажмите на рисунок, чтобы увеличить](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_start/admin_base/bitrix_cloud/cloud_backup_schedule_sm.png) |
  | --- | --- |
  |  |  |
  | ![Нажмите на рисунок, чтобы увеличить](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_start/admin_base/bitrix_cloud/create_auto_backup_sm.png) |  |
