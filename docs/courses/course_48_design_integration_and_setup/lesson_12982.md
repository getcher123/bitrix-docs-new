...
Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=48&LESSON_ID=12982
...
Индексация выполняется по кнопке **Индексировать**:
 ...
 ![perevod_index1.png](../../../images/courses/48/dev.1c-bitrix.ru/upload/medialibrary/c57/perevod_index1.png)

Выполнение этой операции может занять продолжительное время. Чтобы сократить это время, можно выбрать только

			нужные языки

                    ![perevod_index2.png](../../../images/courses/48/dev.1c-bitrix.ru/upload/medialibrary/ba1/perevod_index2.png)
...
![Нажмите на рисунок, чтобы увеличить](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_start/admin_base/interface/perevod_new2_sm.png)
	 ...
	 Подробнее в курсе [Контент-менеджер](lesson_11771.md).
		...
		. Области перевода могут быть ограничены
			...
			настройками модуля
                    ...
                    ![](../../../images/courses/48/dev.1c-bitrix.ru/upload/medialibrary/935/papka_vib0.png)

		. В этом случае в строке поиска появится символ замка c возможностью

			выбора папки

                    ![](../../../images/courses/48/dev.1c-bitrix.ru/upload/medialibrary/c11/papka_vib.png)
 ...
 [Подробнее](lesson_12980.md)...
		 ...
		 функцию **Добавить на панель инструментов кнопку "Выводить языковые файлы"**. Тогда на панели инструментов станет доступна кнопка
			...
			Перевод
                    ...
                    ![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_start/admin_base/interface/button_on_panel.png)
...
![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_start/admin_base/interface/48_result_window.png)
...
![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_start/admin_base/interface/listfiles_window.png)
...
**Задача**: найдем языковое сообщение **Ваша корзина пуста**, используемое на странице
			...
			просмотра корзины
                    ...
                    ![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_start/admin_base/interface/example_page.png)
...
![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_start/admin_base/interface/search_listfiles.png)
