...
Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=48&LESSON_ID=26614
...
![Нажмите на рисунок, чтобы увеличить](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_expert/security/file_scanning-sm.png)
...
![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_expert/security/result_name.png)

		. Откроется форма с описанием следующего вида:

![Нажмите на рисунок, чтобы увеличить](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_expert/security/search_for_trojans-sm.png)
...
- переместить **в карантин**. При этом файл останется в своей текущей директории, но будет переименован – вместо **.php** в расширении файла будет **.ph_** (в таком виде файл не будет выполнятся и, соответственно, не принесёт вреда). Учтите, что если файл используется на сайте, переименование файла приведёт к неработоспособности сайта. Для возврата из карантина кликните по кнопке
  			Восстановить
  ![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_expert/security/recover_from_quarantine.png)
...
![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_expert/security/console_example.png)
...
![Нажмите на рисунок, чтобы увеличить](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_expert/security/operating_system-sm.png)
...
![Нажмите на рисунок, чтобы увеличить](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_expert/security/htaccess_check-sm.png)
...
![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_expert/security/minimum_set.png)
