...
- [Следующий: 20352 — Проверьте себя →](lesson_20352.md)

Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=48&LESSON_ID=2936
...
![Нажмите на рисунок, чтобы увеличить](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_bisness/comment-sm.png)
...
Чтобы **удалить** или **скрыть** комментарий, воспользуйтесь соответствующими пунктами
 ...
 ![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_bisness/menu.png)
