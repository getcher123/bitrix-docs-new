...
Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=48&LESSON_ID=2773
...
- Урок [Настройка репликации MySQL, аварийное переключение slave-&gt;master](/learning/course/index.php?COURSE_ID=35&LESSON_ID=2976) - пример тонкой настройки реплицации.
