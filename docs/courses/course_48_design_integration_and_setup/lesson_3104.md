...
- [Следующий: 20356 — Проверьте себя →](lesson_20356.md)

Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=48&LESSON_ID=3104
...
- с помощью ссылки "**+**", расположенной в столбце **Вопросов** на странице со списком уроков/глав/курсов (Сервисы &gt; Обучение &gt; Курсы&gt; Название курса):
  ![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_expert/learning/add_question1.png)
- с помощью кнопки **Добавить вопрос**, расположенной на странице со списком всех вопросов определенного урока/главы/курса (Сервисы &gt; Обучение &gt; Курсы&gt; Название курса &gt; Вопросы):
  ![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_expert/learning/add_question2.png)
...
- **одиночный выбор** – в списке предложенных вариантов ответов может быть выбран
  			только один ответ
                      ![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_expert/learning/single_question.png)
  		;
- **множественный выбор** – в списке предложенных вариантов ответов может быть выбрано
  			несколько ответов
                      ![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_expert/learning/pluraliry_question.png)
  		.
- **сортировка** – в списке предложенных вариантов ответов необходимо расставить ответы
  			в нужном порядке
                      ![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_expert/learning/sort_question.png)
  		;
- **текстовый ответ** – выводится
  			текстовое поле для самостоятельного ответа
                      ![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_expert/learning/text_question.png)
  		 обучаемым.
...
![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_expert/learning/ques_edit1.png)
...
![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_expert/learning/ques_edit2.png)
...
Для удаления ответа необходимо нажать кнопку ![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_expert/learning/del_button.png) рядом с соответствующей записью.
