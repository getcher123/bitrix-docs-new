...
Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=48&LESSON_ID=2034
...
![Нажмите на рисунок, чтобы увеличить](../../../images/courses/48/dev.1c-bitrix.ru/upload/medialibrary/599/new_jurnal_sm.png)
...
Фильтр позволяет быстро найти в списке нужные события. Работу с фильтром такого типа вы изучали в курсе [Контент-менеджер](lesson_3872.md).

Ссылка

			[стоп-лист]

                    ![](../../../images/courses/48/dev.1c-bitrix.ru/upload/medialibrary/599/jurnal_stop_list.png)
...
- главного модуля на закладке **Журнал событий** (Настройки &gt; Настройки продукта &gt; Настройки модулей &gt; Главный модуль),
  **Примечание**: Обратите внимание на поле
  			Сколько дней хранить события
                      ![](../../../images/courses/48/dev.1c-bitrix.ru/upload/medialibrary/599/count_of_day_jurnal.png)
