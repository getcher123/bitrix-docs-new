...
Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=48&LESSON_ID=7157
...
Покупатель отложил товар в корзину и не сделал заказ. Товар пролежал в корзине более указанного в настройках рассылки **Брошенная корзина**
			...
			срока
                    ...
                    ![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_expert/sender/trigger/trigger_1.png)

		 и тут сработает триггер и владельцу корзины уйдёт заданная

			последовательность писем

                    ![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_expert/sender/trigger/trigger_2.png)
