...
Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=48&LESSON_ID=5081
...
1. Для изучения функционала бывает полезно одновременно с чтением повторять действия, описанные в статье. Чтобы сделать это воспользуйтесь ссылкой
  			Открыть в новой вкладке
                      ![](../../../images/courses/48/dev.1c-bitrix.ru/images/curs_b24/base/support24_2.png)
...
2. Вы можете высказать своё отношение к статье с помощью специальных кнопок:
  ![](../../../images/courses/48/dev.1c-bitrix.ru/images/curs_b24/base/support24_3.png)
