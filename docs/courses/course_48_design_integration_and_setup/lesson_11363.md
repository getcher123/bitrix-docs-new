...
Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=48&LESSON_ID=11363
...
1. Сначала найдите
  			Пользователя с ID=1
  ![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_start/admin_base/user_control/close_1.png)
  		 (Настройки &gt; Пользователи &gt; Список пользователей) и смените E-mail и пароль:
  ![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_start/admin_base/user_control/close_1_change.png)
  ...
  [Подробнее](https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=35&LESSON_ID=12575)...
  		 и отмечена опция
  			Номер телефона является обязательным
  ![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_start/admin_base/user_control/phone_number_is_required.png)
  ...
  **Примечание**: Пользователь с ID=1 по умолчанию является администратором. Конечно, можно лишить его этих прав, сняв
  ...
  ![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_start/admin_base/user_control/close_user1.png)
