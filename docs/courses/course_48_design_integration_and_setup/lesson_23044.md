...
Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=48&LESSON_ID=23044
...
Для того, чтобы авторизация через выбранные сервисы работала, необходимо выполнить отдельные настройки для каждого сервиса в настройках модуля. В главе [Примеры настройки некоторых сервисов](https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=48&CHAPTER_ID=03040&LESSON_PATH=3911.4772.3040) приведены инструкции по подключению.
