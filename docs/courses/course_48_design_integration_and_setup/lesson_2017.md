...
Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=48&LESSON_ID=2017
...
![Нажмите на рисунок, чтобы увеличить](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_start/admin_base/access_control/iblock_access_sm.png)
...
![Переопределение уровня доступа](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_start/admin_base/access_control/iblock_access_redefine_11.png)
...
![Доступ к инфоблоку закрыт](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_start/admin_base/access_control/iblock_no_access.png)
...
После установки флажка в поле
			...
			Расширенное управление правами
                    ...
                    ![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_start/admin_base/access_control/advanced_mode.png)
...
![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_start/admin_base/access_control/full_access_example.png)
...
![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_start/admin_base/access_control/example_of_new_rights.png)
...
![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_start/admin_base/access_control/iblock_access_element_11-new.png)
...
![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_start/admin_base/access_control/web_form_settings_11.png)
...
1. Перейдите на страницу **Список форм** (Сервисы &gt; Веб-формы &gt; Настройка форм);
  ![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_start/admin_base/access_control/web_form_status_11.png)
2. Далее откройте список статусов. Это можно сделать двумя способами:
  ...
  - либо откройте форму редактирования веб-формы (дважды кликнув по строке с названием формы или выбрав пункт контекстного меню **Изменить**), а затем нажмите кнопку
    			Статусы
    ![Статусы результатов](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_start/admin_base/access_control/web_form_status_edit_1_11.png)
...
3. Перейдите к редактированию параметров выбранного статуса, дважды кликнув по строке с его названием или выбрав в пункте контекстного меню **Изменить**, затем выберите вкладку
  			Доступ.
  ![Права доступа к результатам в текущем статусе](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_start/admin_base/access_control/web_form_status_permision_11.png)

### Документация по теме

- [Пример](https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=48&CHAPTER_ID=03797&LESSON_PATH=3906.4503.3797) организации прав доступа;
- [Управление группами пользователей](https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=35&LESSON_ID=7175) (курс Администратор. Базовый).
