...
Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=48&LESSON_ID=6665
...
<!-- &lt;p&gt;&lt;img  src="/images/admin_expert/scale/server_provider1.png"/&gt;&lt;/p&gt; -->
...
[Подробнее ...](lesson_6723.md)
		 ...
		 нужного провайдера. Далее уже выбрать из списка предлагаемых провайдером серверов
			...
			машину нужной конфигурации
                    ...
                    ![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_expert/scale/server_provider2.png)
...
После отработки команды машина появится в списке со статусом
			...
			Сервер предоставлен
                    ...
                    ![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_expert/scale/server_provider4.png)
...
![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_expert/scale/server_provider5.png)
...
![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_expert/scale/server_provider6.png)
