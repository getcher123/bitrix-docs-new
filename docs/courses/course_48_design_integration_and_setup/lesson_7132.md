...
Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=48&LESSON_ID=7132
...
1. Кликнуть на ссылку
  			Зарегистрировать сайт в Битрикс24.Network
                      ![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_expert/social_services/b24n/options_b24network1.png)
  		.
2. В всплывающем окошке ввести
  			адрес сайта
                      ![b24-1.png](../../../images/courses/48/dev.1c-bitrix.ru/upload/medialibrary/e5e/b24-1.png)
  		.
3. Автоматически будут получены
  			Идентификатор портала и Секретный код портала
                      ![b24-2.png](../../../images/courses/48/dev.1c-bitrix.ru/upload/medialibrary/726/b24-2.png)
  		.
4. Нажав на кнопку **Вставить**, полученные идентификаторы
  			автоматически вставятся
                      ![b24-3.png](../../../images/courses/48/dev.1c-bitrix.ru/upload/medialibrary/a88/b24-3.png)
  		 в нужные поля формы.
