...
Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=48&LESSON_ID=13036
...
2. В практических заданиях главы [Создание и настройка инфоблока](https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=34&LESSON_ID=13032) вы создали информационный блок **Вещи для сна**. Выполните импорт файла CSV в этот инфоблок со следующей информацией:
