...
Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=48&LESSON_ID=2101
...
![Нажмите на рисунок, чтобы увеличить](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_expert/analytics/webanalytics_module_settings_sm.png)
...
На закладке
			...
			Рекламные кампании
                    ...
                    ![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_expert/analytics/webanalytics_module_settings_tab2_sm.png)
...
На закладке
			...
			Страна и город
                    ...
                    ![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_expert/analytics/webanalytics_module_settings_tab3_sm.png)
...
На закладке
			...
			Настройка данных
                    ...
                    ![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_expert/analytics/webanalytics_module_settings_tab4_sm.png)
...
Параметры закладки
			...
			Время хранения
                    ...
                    ![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_expert/analytics/webanalytics_module_settings_tab5_sm.png)
...
На закладке
			...
			Исключения
                    ...
                    ![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_expert/analytics/webanalytics_module_settings_tab6_sm.png)
...
- **Очистка БД** от устаревших данных. (Исключение составляют таблица поисковиков (здесь будут сброшены только счетчики) и таблицы привязки IP-адресов к странам.)
  ![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_expert/analytics/clear_stats.png)
- **Оптимизация таблиц** модуля **Веб-аналитика** для уменьшения их размера и увеличения производительности.
  ![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_expert/analytics/optimize_db.png)
