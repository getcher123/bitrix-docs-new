...
Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=48&LESSON_ID=2731
...
![Монитор производительности](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_expert/cluster/perfmon_test_1.png)
...
- **Сервер**, который будет тестироваться. Для минимизации влияния самого тестирующего скрипта на результаты тестов рекомендуется запускать его не на тестируемых серверах, а на отдельном хосте.
  Также на тестируемом сайте необходимо на время проведения теста отключить опцию блокировки пользователя при большом количестве соединений (
  			Блокировать?
                      ![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_expert/cluster/block.png)
...
![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_expert/cluster/test_graphic.png)
