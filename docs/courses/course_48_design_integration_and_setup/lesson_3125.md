...
Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=48&LESSON_ID=3125
...
![Настройка прав доступа к модулю Документооборот](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_expert/workflow/doc_options_1.png)
