...
Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=48&LESSON_ID=2072
...
![Языковые файлы](../../../images/courses/48/dev.1c-bitrix.ru/upload/medialibrary/a2d/jazuk_files.png)
...
3. На закладке **Список обновлений** открывшейся странице отметьте языковые файлы для испанского языка, которые будут загружены в систему:
  ![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_start/admin_base/interface/la_lang_file_upload.png)
