...
Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=48&LESSON_ID=1929
...
![](../../../images/courses/48/dev.1c-bitrix.ru/images/portal_admin/system_administration/basic_administration/information/edit_properties_page.png)

		:

![](../../../images/courses/48/dev.1c-bitrix.ru/images/portal_admin/system_administration/basic_administration/information/prop_sv_text_11.png)
...
![](../../../images/courses/48/dev.1c-bitrix.ru/images/portal_admin/system_administration/basic_administration/information/prop_catalog_admin_11.png)
...
![Типы для каждого сайта](../../../images/courses/48/dev.1c-bitrix.ru/images/portal_admin/system_administration/basic_administration/information/prop_types.png)
...
- Отметьте опцию
  			Использовать индивидуальные настройки для каждого сайта
                      ![](../../../images/courses/48/dev.1c-bitrix.ru/images/portal_admin/system_administration/basic_administration/information/prop_site.png)
  		;
...
![](../../../images/courses/48/dev.1c-bitrix.ru/images/portal_admin/system_administration/basic_administration/information/preview_without_image.png)
...
1. Перейдем на страницу настроек модуля **Управление структурой** (Настройки &gt; Настройки продукта &gt; Настройки модулей &gt; Управление структурой). В секции **Настройки для сайтов** укажем сайт 1 и добавим новый тип **og:image** с названием 2 :
  ![](../../../images/courses/48/dev.1c-bitrix.ru/images/portal_admin/system_administration/basic_administration/information/new_type_of_property_ogimage.png)
2. Мета-тег ещё не прописан в шаблоне нашего сайта. Поэтому добавим код для вывода разметки в файл **header.php**
  ...
  ```
  ![](../../../images/courses/48/dev.1c-bitrix.ru/images/portal_admin/system_administration/basic_administration/information/add_new_meta_teg.png)
...
4. Перейдем в раздел сайта О магазине (`/about`) и откроем форму редактирования свойств. Увидим, что там отобразилось созданное нами свойство. Укажем для него ссылку на изображение:
  ![](../../../images/courses/48/dev.1c-bitrix.ru/images/portal_admin/system_administration/basic_administration/information/about_section_property.png)
5. Выполним
  			очистку кеша
  ...
  [Подробнее...](https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=35&LESSON_ID=2164&LESSON_PATH=3906.6663.2129.2164)
...
![](../../../images/courses/48/dev.1c-bitrix.ru/images/portal_admin/system_administration/basic_administration/information/preview_with_image.png)
