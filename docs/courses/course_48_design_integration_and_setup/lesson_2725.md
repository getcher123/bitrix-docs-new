...
Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=48&LESSON_ID=2725
...
- Практический пример: урок [Кластеризация кеша (memcached)](/learning/course/index.php?COURSE_ID=35&LESSON_ID=2989);
