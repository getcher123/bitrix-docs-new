...
Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=48&LESSON_ID=2964
...
![Нажмите на рисунок, чтобы увеличить](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_expert/forum/v12/forum_admin_new_sm.png)
...
1. на вкладке
  			Форум
                      ![Параметры](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_expert/forum/v12/forum_edit1.png)
  		:
...
2. на вкладке
  			Настройки
                      ![Детальные настройки](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_expert/forum/v12/forum_edit2.png)
  		:
...
3. на вкладке
  			Доступ
                      ![Права доступа](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_expert/forum/v12/forum_edit3.png)
  		 определите
  			права доступа
...
Чтобы отредактировать форум, воспользуйтесь пунктом контекстного меню
			...
			Изменить
                    ...
                    ![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_expert/forum/v12/forum_edit_menu.png)
