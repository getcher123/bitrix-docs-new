...
Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=48&LESSON_ID=11797
...
- **левый клик** на кнопке меню действий или **правый клик** на строке таблицы отчета - вывод меню действий:
  | ![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_start/admin_base/interface/element_prop_left_11.png) | или | ![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_start/admin_base/interface/element_prop_right_11.png) |
  | --- | --- | --- |
- **Ctrl + правая кнопка** - выводит стандартное меню браузера:
  ![stand_menu.png](../../../images/courses/48/dev.1c-bitrix.ru/upload/medialibrary/1c8/stand_menu.png)
