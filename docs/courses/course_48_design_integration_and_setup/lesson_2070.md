...
Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=48&LESSON_ID=2070
...
В публичном разделе сайта служебные сообщения системы, а также
			...
			текстовые сообщения визуальных компонентов
                    ...
                    ![](../../../images/courses/48/dev.1c-bitrix.ru/upload/medialibrary/bbb/vis-comp.jpg)
...
![reg_nast.jpg](../../../images/courses/48/dev.1c-bitrix.ru/upload/medialibrary/949/reg_nast.jpg)
...
Для каждого модуля системы создается набор специальных языковых файлов. Они хранятся в папках с названиями соответствующих языков. В файлах содержатся переводы фраз, используемых в интерфейсе, на эти языки.
 ...
 ![Нажмите на рисунок, чтобы увеличить](../../../images/courses/48/dev.1c-bitrix.ru/upload/medialibrary/93d/lang_sm.jpg)

По умолчанию в системе используются русский и английский языки.

			Выбор текущего языка

                    ![choice.jpg](../../../images/courses/48/dev.1c-bitrix.ru/upload/medialibrary/55d/choice.jpg)
