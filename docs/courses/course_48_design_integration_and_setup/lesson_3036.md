...
Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=48&LESSON_ID=3036
...
- **Транслировать твиты пользователей с хештегом в живую ленту** - указываются хештеги, с которым будут
  ...
  [Подробнее](https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=48&LESSON_ID=7135)...
  		 в Живую ленту;
- Далее из списка выбираются необходимые **социальные сервисы**, с помощью которых будет доступна авторизация;
- Ниже под каждым сервисом есть рекомендации и ссылки для регистрации сайта в своей системе получения соответствующих уникальных идентификаторов и секретных ключей. А в главе [Примеры настройки некоторых сервисов](https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=48&CHAPTER_ID=03040&LESSON_PATH=3911.4772.3040) приведены инструкции по подключению.
