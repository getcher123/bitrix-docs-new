...
- [← Предыдущий: 2952 — Управление выпусками ручной рассылки](lesson_2952.md)
- [Следующий: 3534 — Типы событий →](lesson_3534.md)

Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=48&LESSON_ID=3523
...
![](../../../images/courses/48/dev.1c-bitrix.ru/images/portal_admin/admin_sys/mail/shablons_11.png)
...
![](../../../images/courses/48/dev.1c-bitrix.ru/images/portal_admin/admin_sys/mail/edit_shab_11.png)
...
- **От кого** - указывается адрес отправителя почтового сообщения. Для шаблонов, связанных с работой интернет-магазина, по умолчанию установлен макрос `#SALE_EMAIL#` (это
  ...
  ![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_bisness/inet_mag/orders/sale_email.png)
...
- **Кому** - указываются
  ...
  ![](../../../images/courses/48/dev.1c-bitrix.ru/images/portal_admin/admin_sys/mail/how_list_emails.png)
...
![](../../../images/courses/48/dev.1c-bitrix.ru/images/portal_admin/admin_sys/mail/fields_email.png)
...
![](../../../images/courses/48/dev.1c-bitrix.ru/images/portal_admin/admin_sys/mail/fields_11_new.png)
...
![](../../../images/courses/48/dev.1c-bitrix.ru/images/portal_admin/admin_sys/mail/add_new_post_sh.png)
...
![Нажмите на рисунок, чтобы увеличить](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_bisness/inet_mag/orders/mail_order_example-sm.png)
