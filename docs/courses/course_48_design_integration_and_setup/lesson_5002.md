...
Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=48&LESSON_ID=5002
...
![2etapauto.png](../../../images/courses/48/dev.1c-bitrix.ru/upload/medialibrary/99f/2etapauto.png)
...
- **Размер окна проверки паролей** - задается размер окна проверки паролей, если используется алгоритм генерации паролей **по счетчику** (
  ...
  ![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_expert/security/otp/eToken_pass.png)
