...
Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=48&LESSON_ID=3261
...
![Нажмите на рисунок, чтобы увеличить](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_start/admin_base/security/https_sm.png)
...
- Изменить ссылки, используемые в проекте, с абсолютных путей на относительные: в каждом файле проекта
  ...
  ![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_start/admin_base/security/search_http.png)
...
- Проверить и изменить ссылки для контента (видео, картинки), загружаемого со сторонних ресурсов, протокол, по которому проект запрашивает контент.
  ...
  ![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_start/admin_base/security/https_1.png)
