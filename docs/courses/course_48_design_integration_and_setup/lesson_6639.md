...
Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=48&LESSON_ID=6639
...
- Запускать внешнее сканирование.
  **Примечание:** Внешнее сканирование будет запущено, если сайт доступен снаружи (например, расположен на хостинге, а не на локальной машине) и в опции **URL сайта (без http://)**
  ...
  ![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_expert/seo/seo_1.png)
...
![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_expert/security/security_scanner_result.png)
