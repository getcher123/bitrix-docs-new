...
Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=48&LESSON_ID=5330
...
Форма создания резервной копии:
 ...
 [![Нажмите на рисунок, чтобы увеличить](../../../images/courses/48/dev.1c-bitrix.ru/upload/medialibrary/649/rez_kop.png)](jav * ascript:ShowImg('/upload/medialibrary/649/rez_kop.png',1036,768,'Резервное копирование'))
...
1. Компания "1С-Битрикс" бесплатно предоставляет место в облаке для хранения трех резервных копий на каждую активную лицензию.
  		...
  		![](../../../images/courses/48/dev.1c-bitrix.ru/upload/medialibrary/7e9/compare1.png)
  		![](../../../images/courses/48/dev.1c-bitrix.ru/upload/medialibrary/7e9/compare2.png)
...
Созданная резервная копия отображается на странице Настройки &gt; Инструменты &gt; Резервное копирование &gt; Список резервных копий. С помощью
			...
			меню действий
                    ...
                    ![spisok_rez_kopii.png](../../../images/courses/48/dev.1c-bitrix.ru/upload/medialibrary/1a6/v0yela0ayfy0uaj8jid57u0zhkheowg6/spisok_rez_kopii.png)
...
3. Восстановление сайтов потребует дополнительных действий со стороны администратора:
  ...
  - Учтите, что из выбранных сайтов в состав архива полностью копируется только первый по сортировке в [списке сайтов](https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=35&LESSON_ID=1991). Соответственно, при восстановлении в полностью работоспособном состоянии восстанавливается только этот сайт.
...
[![Нажмите на рисунок, чтобы увеличить](../../../images/courses/48/dev.1c-bitrix.ru/upload/medialibrary/702/rez_kop_param.png)](jav * ascript:ShowImg('/upload/medialibrary/702/rez_kop_param.png',963,966,'Параметры резервного копирования'))
...
- Величина поля
  			Длительность шага
                      ![](../../../images/courses/48/dev.1c-bitrix.ru/upload/medialibrary/fa0/dlit_shaga.png)
...
- Если настроено несколько сайтов с разными путями к корневой папке веб-сервера, они сохраняются и восстанавливаются отдельно. При этом полный архив делается один раз. А затем, при архивации других сайтов, необходимо будет
  			исключить ядро и базу данных
                      ![](../../../images/courses/48/dev.1c-bitrix.ru/upload/medialibrary/722/iskl_yadro.png)
...
- Если копия будет сохраняться
  			локально
                      ![](../../../images/courses/48/dev.1c-bitrix.ru/upload/medialibrary/e2f/lokal.png)
...
- Суть
  			Проверки целостности архива после его завершения
                      ![](../../../images/courses/48/dev.1c-bitrix.ru/upload/medialibrary/12d/cel.png)
