...
Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=48&LESSON_ID=5133
...
Перейдите в раздел **Компания** и нажмите **Изменить раздел** и выберите пункт меню
			...
			Доступ к разделу
                    ...
                    ![пункт меню "Доступ к разделу"](../../../images/courses/48/dev.1c-bitrix.ru/images/content_manager/information/razdel_prop.png)
...
В категории **Пользователи**
			...
			поиском найдите сотрудника Дашу
                    ...
                    ![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_start/admin_base/access_control/dasha_new.png)
...
![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_start/admin_base/access_control/dasha_write.png)
...
![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_start/admin_base/other/group_editors_11_new.png)
...
Затем в административном разделе пройдите на страницу Контент &gt; Структура сайта &gt; Файлы и папки &gt; bitrix и выберите в меню действий папки **admin** пункт
			...
			Права на доступ продукта
                    ...
                    ![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_start/admin_base/other/bitrix_admin_11_new.png)
...
![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_start/admin_base/other/editors_read_11_new.png)
