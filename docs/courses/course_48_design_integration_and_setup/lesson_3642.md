...
Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=48&LESSON_ID=3642
...
![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_expert/forms/crm.png)
...
Откройте
			...
			выпадающий список
                    ...
                    ![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_expert/forms/choose_crm.png)
...
![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_expert/forms/my_new_crm.png)
...
![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_expert/forms/opt_con_crm.png)
...
Если в веб-форме нет данных, подходящих нужному полю лида, выберите пункт
			...
			Создать новый вопрос
                    ...
                    ![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_expert/forms/connect_fields2.png)
...
**Примечание**. Если в веб-форме используется шаблон формы по умолчанию, то созданный вопрос автоматически отобразится в форме. Если используется свой шаблон, то откройте шаблон на редактирование и в разделе **Существующие поля формы**
			...
			добавьте вопрос в шаблон формы
                    ...
                    ![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_expert/forms/field_crm_add.png)
...
![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_expert/forms/send_to_crm2.png)
...
Если данные переданы успешно, выведется сообщение о
			...
			добавлении лида
                    ...
                    ![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_expert/forms/add_lead_id2.png)
...
![](../../../images/courses/48/dev.1c-bitrix.ru/images/bitrix24/anke.png)
