...
- [← Предыдущий: 10259 — Что ищется?](lesson_10259.md)
- [Следующий: 2056 — Морфологический поиск →](lesson_2056.md)

Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=48&LESSON_ID=2053
...
Пользователь сам выбирает режим сортировки на странице с результатами поиска с помощью ссылок в конце списка найденных документов:
			...
			Сортировать по релевантности
                    ...
                    ![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_start/admin_base/search/search_sort_rel.png)

		 или

			Сортировать по дате

                    ![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_start/admin_base/search/search_sort_date.png)
...
![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_start/admin_base/search/sort_rules.png)
...
- **Первый этап**: управление правилами сортировки - создание, правка или удаление правил.
  В
  			форме создания/редактирования правила
                      ![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_start/admin_base/search/sort_rules_add_new.png)
...
- **Второй этап**: обновление поискового индекса для вступления новых правил в силу.
  Обновление поискового индекса выполняется по кнопке
  			Обновить
                      ![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_start/admin_base/search/sort_rules_update.png)
  		. По окончании процедуры обновления индекса будет выведено
  			сообщение
                      ![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_start/admin_base/search/sort_rules_result.png)
  		 о ее результатах.
