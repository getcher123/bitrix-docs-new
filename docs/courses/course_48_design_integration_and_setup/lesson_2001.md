...
Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=48&LESSON_ID=2001
...
![Нажмите на рисунок, чтобы увеличить](../../../images/courses/48/dev.1c-bitrix.ru/images/content_manager/iblocks/xml_export_fedit_sm.png)
...
**Шаг 3.** Нажмите кнопку **Экспортировать**. Начинается экспорт инфоблока, над формой отображается ход процесса выгрузки. По окончании выводится соответствующее
			...
			сообщение
                    ...
                    ![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_start/iblock/export_end2.png)
