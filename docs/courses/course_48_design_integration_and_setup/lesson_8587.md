...
Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=48&LESSON_ID=8587
...
Административные настройки  для каждой формы выполняются таким же образом, как и [пользовательская настройка](/learning/course/index.php?COURSE_ID=48&LESSON_ID=02074), но с установкой флажка **Установить данные настройки по умолчанию для всех пользователей**.
...
![Персональные настройки](../../../images/courses/48/dev.1c-bitrix.ru/upload/medialibrary/31b/pers_nastr.png)
...
- Раздел **Меню "Пуск"** позволяет:
  ...
  - определить количество часто используемых ссылок, которое будет выведено в **Меню** под **Избранным**:
    ![Меню](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_start/admin_base/interface/menu_items_11.png)
...
![eraser.png](../../../images/courses/48/dev.1c-bitrix.ru/upload/medialibrary/4d0/eraser.png)
