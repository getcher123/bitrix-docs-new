...
Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=48&LESSON_ID=21582
...
![Nginx-PushStreamModule](../../../images/courses/48/dev.1c-bitrix.ru/upload/medialibrary/4bb/bitrixvm_push2.jpg)
...
![Install/Update NodeJS RTC service](../../../images/courses/48/dev.1c-bitrix.ru/upload/medialibrary/e31/bitrixvm_push3.jpg)
...
![NodeJS RTC Push&Pull](../../../images/courses/48/dev.1c-bitrix.ru/upload/medialibrary/c56/bitrixvm_push4.jpg)
...
В административном разделе в Настройки &gt; Настройки продукта &gt; Настройки модулей &gt; Push and Pull мы видим, что сервер очередей настроен на модуль
			...
			nginx-push-stream-module
                    ...
                    ![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_expert/pull/pnp_admin_nginx.png)
