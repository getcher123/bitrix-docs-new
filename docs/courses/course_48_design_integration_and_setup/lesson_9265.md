...
Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=48&LESSON_ID=9265
...
1. В настройках веб-формы отметьте опцию **Отправлять результаты по email**.
  ![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_expert/forms/form_simple_email.png)
2. Сохраните настройки, нажав **Применить**. Система автоматически создаст почтовый шаблон.
3. Перейдите по ссылке **[список шаблонов]**.
4. Откройте
  			созданный шаблон
                      ![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_expert/forms/form_mail_template.png)
  		 и убедитесь, что он:
...
1. Во вкладке **Дополнительно** настроек веб-формы создайте шаблон для отправки результатов:
  ![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_expert/forms/form_email.png)
2. Перейдите по
  			ссылке с его номером
                      ![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_expert/forms/templ_id.png)
...
- [Расширенный режим](https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=48&CHAPTER_ID=02927)
