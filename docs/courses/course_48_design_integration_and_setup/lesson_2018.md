...
Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=48&LESSON_ID=2018
...
- Найдите в списке файлов файл нужного меню: **Меню типа "****"**. В колонке действий выберите
  			Редактировать меню
                      ![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_start/admin_base/information/menu_razsh.png)
