...
Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=48&LESSON_ID=25072
...
1. Выполните настройки со стороны сервиса [im.edna.ru](https://im.edna.ru/auth/signin):
  ...
  - Перейдите на страницу профиля в личном кабинете и скопируйте **API-ключ**:
     ![Нажмите на рисунок, чтобы увидеть рисунок в полномасштабном режиме](../../../images/courses/48/dev.1c-bitrix.ru/images/portal_admin/messaging_service/edna_wa_api_sm.png)
  - В поле **Callback URL** укажите следующий адрес: https://[имя_вашего_сайта]/bitrix/tools/messageservice/callback_ednaru.php.
     ![Нажмите на рисунок, чтобы увидеть рисунок в полномасштабном режиме](../../../images/courses/48/dev.1c-bitrix.ru/images/portal_admin/messaging_service/edna_wa_callback_sm.png)
    **Важно!** Сайт должен работать по протоколу
    ...
    Подробнее в курсе [Администратор. Базовый](lesson_3261.md).
    		.
  - Скопируйте **код отправителя** из вашего аккаунта. Взять его можно в разделе **Сводка**, рядом с номером телефона в скобках (в примере это Bitrix2_WA).
    ![](../../../images/courses/48/dev.1c-bitrix.ru/images/portal_admin/messaging_service/edna_wa_code_sm.png)
2. Выполните настройки со стороны *1С-Битрикс: Управление сайтом* или *1С-Битрикс24*:
  ...
  - В открывшейся форме введите скопированные ранее **API-ключ** и **код отправителя**:
    ![](../../../images/courses/48/dev.1c-bitrix.ru/images/portal_admin/messaging_service/bitrix_edna_wa.png)
