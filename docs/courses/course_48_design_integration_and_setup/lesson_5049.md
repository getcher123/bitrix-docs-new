...
- [Следующий: 20370 — Проверьте себя →](lesson_20370.md)

Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=48&LESSON_ID=5049
...
4. [Создание и настройка](/learning/course/index.php?COURSE_ID=41&LESSON_ID=2759) необходимых статусов для документов.
...
![Настройка прав доступа к модулю Управление структурой](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_expert/workflow/doc_options_3.png)
...
В **Менеджере файлов** для папок и файлов, где будет размещаться информационный блок, для этой же группы
			...
			установите право
                    ...
                    ![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_expert/workflow/admin_folder.png)

		 доступа **Документооборот**:



![Настройка прав доступа к папкам и файлам](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_expert/workflow/doc_options_4.png)
