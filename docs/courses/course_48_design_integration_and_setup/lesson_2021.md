...
Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=48&LESSON_ID=2021
...
![](../../../images/courses/48/dev.1c-bitrix.ru/images/content_manager/gif/add_section-admin.gif)
...
![](../../../images/courses/48/dev.1c-bitrix.ru/images/content_manager/gif/add_page-admin.gif)
...
![](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_start/admin_base/information/add_page_adm_11.png)
...
Для режимов правки файлов **Редактировать как текст** и **Редактировать как PHP** доступен
		 ...
		 с нумерацией строк и
			...
			подсветкой синтаксиса
                    ...
                    ![](../../../images/courses/48/dev.1c-bitrix.ru/images/content_manager/visual_editor/operation_modes/syntax_highlight_editor.png)
...
![](../../../images/courses/48/dev.1c-bitrix.ru/images/content_manager/visual_editor/operation_modes/apply_changes.png)
...
![](../../../images/courses/48/dev.1c-bitrix.ru/images/content_manager/visual_editor/operation_modes/edit_file.png)
...
- Закладка **Редактирование**.
  			Выбирается шаблон страницы, указывается ее заголовок и название для файла
                      ![](../../../images/courses/48/dev.1c-bitrix.ru/images/content_manager/visual_editor/additional_features/create_page_menu.png)
  		, в котором данная страница будет сохранена.
  По умолчанию **Имя файла** формируется автоматически из поля **Заголовок страницы**. Если кликнуть по иконке ![](../../../images/courses/48/dev.1c-bitrix.ru/images/content_manager/information/translit.png), то автоматическое формирование файла отключится, и имя файла можно будет ввести
  			вручную
  ![](../../../images/courses/48/dev.1c-bitrix.ru/images/content_manager/visual_editor/operation_modes/transliteration.png)
  		. При ручном вводе допускается кириллица, но запрещены спецсимволы: **\ / ? * &lt; &gt; " '**.
  Визуальный HTML редактор выглядит так:
  ![](../../../images/courses/48/dev.1c-bitrix.ru/images/content_manager/new_visual_editor/VE_new.png)
  ...
  **Сниппет** – это заранее подготовленный фрагмент текста или кода, этакие заготовки. Предположим, что вам каждый день приходится вставлять на страницы сайта одну и ту же таблицу или форму. Вы можете сохранить эту таблицу в сниппетах и затем простым перетаскиванием размещать её в нужном месте.
  		. Панель может быть скрыта. Раскройте её нажатием на
  			стрелочку
                      ![](../../../images/courses/48/dev.1c-bitrix.ru/images/content_manager/new_visual_editor/components/hidden_panel_visred.png)
...
- На закладке **Меню** можно добавить пункт в меню текущего раздела сайта (т.е. раздела, в котором создается страница), ссылающийся на созданную страницу.
  ![](../../../images/courses/48/dev.1c-bitrix.ru/images/content_manager/visual_editor/operation_modes/admin_editor_tab3_11.png)
...
В самом **Административном разделе** переход к редактированию или удалению страницы и раздела осуществляется из
			...
			Менеджера файлов
                    ...
                    ![](../../../images/courses/48/dev.1c-bitrix.ru/images/content_manager/visual_editor/operation_modes/to_edit_page_from_admin_11.png)
