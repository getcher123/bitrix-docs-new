...
- [← Предыдущий: 25010 — Настройка прав доступа к публичному разделу складского учета](lesson_25010.md)
- [Следующий: 2449 — Календари →](lesson_2449.md)

Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=48&LESSON_ID=22634
...
3. Затем
  ...
  ![Нажмите на рисунок, чтобы увеличить](../../../images/courses/48/dev.1c-bitrix.ru/images/admin_start/admin_base/transition-to-b24/ol_widget5_sm.png)
