...
- [← Предыдущий: 24568 — Практические задания](lesson_24568.md)
- [Следующий: 3079 — Настройки модуля и группы серверов →](lesson_3079.md)

Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=48&LESSON_ID=3018
