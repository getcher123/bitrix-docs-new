...
- [← Предыдущий: 29880 — Установка пакетов](lesson_29880.md)
- [Следующий: 9229 — Конфигурация PHP →](lesson_9229.md)

Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=135&LESSON_ID=9227
