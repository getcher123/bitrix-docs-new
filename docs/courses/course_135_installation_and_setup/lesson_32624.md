...
- [← Предыдущий: 32622 — Установка пакетов](lesson_32622.md)
- [Следующий: 32626 — Конфигурация PHP →](lesson_32626.md)

Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=135&LESSON_ID=32624
...
Все конфигурационные файлы можно [скачать в архиве](https://dev.1c-bitrix.ru/docs/chm_files/cfg.zip). Конфигурационные файлы для Nginx расположены в папке `/cfg/nginx/`.
...
```
 ...
 rsync -av /opt/cfg/nginx/ /etc/nginx/
```
...
```
echo "127.0.0.1 push httpd rosa.bx" >> /etc/hosts
```
