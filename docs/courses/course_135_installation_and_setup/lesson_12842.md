...
- [← Предыдущий: 12834 — Переход на «1С-Битрикс24: Интернет-магазин + CRM» с БУС](lesson_12834.md)
- [Следующий: 12878 — Виртуальная машина: многосайтовость для перехода на «1С-Битрикс24» →](lesson_12878.md)

Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=135&LESSON_ID=12842
...
1. Первым делом необходимо
  ...
  **2.** Установите рекомендуемые обновления.
  ![](../../../images/courses/135/dev.1c-bitrix.ru/images/admin_start/admin_base/b24new/update.png)
...
2. После загрузки обновлений перейдите в раздел **Сайты и Магазины** и **Создайте девелоперский сайт**:
  ![Нажмите на рисунок, чтобы увеличить](../../../images/courses/135/dev.1c-bitrix.ru/images/admin_start/admin_base/b24new/sites_and_shops-sm.png)
3. В открывшемся окне запустите **Мастер установки девелоперского сайта** (этот мастер добавит в корень
  ...
  Для корректной работы обоих сайтов (портала Битрикс24 и интернет-магазина) должна быть предварительно настроена многосайтовость на разных доменах.
  		 установочный файл интернет-магазина), нажав кнопку
  			Продолжить.
  ![](../../../images/courses/135/dev.1c-bitrix.ru/images/admin_start/admin_base/b24new/button.png)
4. Подтвердите
  ![](../../../images/courses/135/dev.1c-bitrix.ru/images/admin_start/admin_base/b24new/reserve_next.png)
...
5. На следующем этапе Мастер укажет, какие модули еще необходимо установить. Перейдите по указанной
  			ссылке.
  ![](../../../images/courses/135/dev.1c-bitrix.ru/images/admin_start/admin_base/b24new/add_module.png)
6. В каталоге Marketplace выберите и установите одно из готовых решений сайта (например, **Интернет-магазин**):
  ![Нажмите на рисунок, чтобы увеличить](../../../images/courses/135/dev.1c-bitrix.ru/images/admin_start/admin_base/b24new/int-mag-sm.png)
7. После установки модуля вернитесь в **Мастер установки девелоперского сайта** (Мастер пропустит уже выполненные шаги). Подтвердите, что на вашем сайте настроена многосайтовость на разных доменах:
  ![Нажмите на рисунок, чтобы увеличить](../../../images/courses/135/dev.1c-bitrix.ru/images/admin_start/admin_base/b24new/master-sm.png)
8. Далее укажите данные сайта, куда необходимо установить интернет-магазин, и нажмите кнопку **Продолжить**:
  ![](../../../images/courses/135/dev.1c-bitrix.ru/images/admin_start/admin_base/b24new/info_m_2.png)
9. Дождитесь завершения работы Мастера, и нажмите кнопку
  			Перейти на сайт.
  ![](../../../images/courses/135/dev.1c-bitrix.ru/images/admin_start/admin_base/b24new/finish.png)
  ...
  ![Нажмите на рисунок, чтобы увеличить](../../../images/courses/135/dev.1c-bitrix.ru/images/admin_start/admin_base/b24new/master_sale-sm.png)
...
![](../../../images/courses/135/dev.1c-bitrix.ru/images/admin_start/admin_base/transition-to-b24/button.gif)
...
**Примечание**: Интернет-магазин можно создать на собственном домене. Для этого ознакомьтесь с [этим описанием](https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=41&LESSON_ID=12629).
