...
- [← Предыдущий: 5412 — Выбор хостинга](lesson_5412.md)
- [Следующий: 2599 — Поддержка стандартов и технологий. Требования к клиентскому программному обеспечению →](lesson_2599.md)

Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=135&LESSON_ID=2593
...
- [Запуск виртуальной машины BitrixVM](https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=37&LESSON_ID=29238) — «1C-Битрикс: Виртуальная машина» сконфигурирована для быстрого исполнения продуктов 1С-Битрикс. На виртуальную машину можно не только установить ознакомительные версии продуктов 1С-Битрикс, но и перенести уже готовые проекты.
- [Установка «1С-Битрикс: Веб-окружение» — Linux (BitrixEnv)](https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=37&LESSON_ID=29234) — позволяет быстро развернуть оптимальное окружение для работы продуктов и решений 1С-Битрикс на Linux-платформе CentOS Stream 9.
  С версии BitrixEnv 9.0.4 добавлена поддержка операционных систем Rocky Linux 9, Alma Linux 9, Oracle Linux 9.

Настройки окружения при использовании других ОС описаны в главе [Установка БУС/КП на другие окружения](https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=135&CHAPTER_ID=020866):

- [Настройка окружения для SUSE Linux Enterprise Server 15](https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=135&CHAPTER_ID=020872),
- [Настройка окружения для РЕД ОС 8](https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=135&CHAPTER_ID=029876),
- [Настройка окружения для РЕД ОС 7.3](https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=135&CHAPTER_ID=016822),
- [Настройка окружения для ALT 8 SP Server](https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=135&CHAPTER_ID=020394),
- [Настройка окружения для RedHat8](https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=135&CHAPTER_ID=020916),
- [Настройка окружения для Debian 11](https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=135&CHAPTER_ID=05360),
- [Настройка окружения для Astra Linux 1.8](https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=135&CHAPTER_ID=031580).
