...
- [← Предыдущий: 31042 — Установка пакетов](lesson_31042.md)
- [Следующий: 31052 — Конфигурация PHP →](lesson_31052.md)

Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=135&LESSON_ID=31050
...
```
 ...
 rsync -av /opt/debian/nginx/ /etc/nginx/
```
