...
- [← Предыдущий: 20920 — Установка пакетов](lesson_20920.md)
- [Следующий: 20924 — Конфигурация PHP →](lesson_20924.md)

Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=135&LESSON_ID=20922
...
Все конфигурационные файлы можно [скачать в архиве](/docs/chm_files/redhat8.zip). Конфигурационные файлы для Nginx расположены в папке: `redhat8/nginx`.
