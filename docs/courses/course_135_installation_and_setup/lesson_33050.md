...
- [← Предыдущий: 33048 — Установка пакетов](lesson_33048.md)
- [Следующий: 33052 — Конфигурация PHP →](lesson_33052.md)

Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=135&LESSON_ID=33050
