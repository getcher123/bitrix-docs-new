...
- [Следующий: 2707 — Необходимый уровень прав на сервере →](lesson_2707.md)

Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=135&LESSON_ID=15292
