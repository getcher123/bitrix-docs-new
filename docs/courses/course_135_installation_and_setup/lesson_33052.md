...
- [← Предыдущий: 33050 — Конфигурация Nginx](lesson_33050.md)
- [Следующий: 33054 — Конфигурация Apache →](lesson_33054.md)

Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=135&LESSON_ID=33052

В Альт СП 10 хранилище конфигурации PHP версии 8.3 расположено в папках:
