...
- [← Предыдущий: 20894 — Установка пакетов](lesson_20894.md)
- [Следующий: 20898 — Конфигурация php →](lesson_20898.md)

Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=135&LESSON_ID=20896
