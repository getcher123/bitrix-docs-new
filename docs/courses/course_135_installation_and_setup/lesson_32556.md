...
- [← Предыдущий: 32554 — Конфигурация Redis](lesson_32554.md)
- [Следующий: 32558 — Конфигурация сайта →](lesson_32558.md)

Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=135&LESSON_ID=32556
...
11. Запустите сервис:
  ...
  ```
12. Выполните настройки Push-сервера, которые описаны [в следующем уроке](lesson_32558.md).
