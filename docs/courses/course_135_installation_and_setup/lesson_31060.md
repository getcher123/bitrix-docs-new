...
- [← Предыдущий: 31058 — Конфигурация Redis](lesson_31058.md)
- [Следующий: 31062 — Конфигурация сайта →](lesson_31062.md)

Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=135&LESSON_ID=31060
...
11. Запустите сервис:
  ...
  ```
12. Выполните настройки Push-сервера, описанные [в следующем уроке](lesson_31062.md).
