...
- [← Предыдущий: 32916 — Установка пакетов](lesson_32916.md)
- [Следующий: 32920 — Конфигурация PHP →](lesson_32920.md)

Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=135&LESSON_ID=32918
