...
- [Следующий: 2708 — Использование файлов .htaccess →](lesson_2708.md)

Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=135&LESSON_ID=2707
...
| ![](../../../images/courses/135/dev.1c-bitrix.ru/images/portal_admin/install/additional/folder_chmod.png) |  | ![](../../../images/courses/135/dev.1c-bitrix.ru/images/portal_admin/install/additional/file_chmod.png) |
| --- | --- | --- |
| *Установка прав на папки* |  | *Установка прав на файлы* |

Модуль **Управление структурой** позволяет просмотреть

			права на доступ

                    ![](../../../images/courses/135/dev.1c-bitrix.ru/images/portal_admin/install/additional/v12/siteman_sm.png)

		 к файлам и папкам, установленные на уровне системы.
