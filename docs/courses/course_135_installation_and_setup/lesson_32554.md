...
- [← Предыдущий: 32552 — Конфигурация PostgreSQL](lesson_32552.md)
- [Следующий: 32556 — Конфигурация Push-server →](lesson_32556.md)

Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=135&LESSON_ID=32554
