...
Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=135&LESSON_ID=2163

[Перенос сайта нештатными средствами](#ex1)
  [Настройки PHP](#ex2)
  [Возможные проблемы при работе с многосайтовостью](#ex3)
  [Распакованный сайт недоступен](#ex4)
  [Не полный архив](#ex5)
  [Ошибка ERROR 1062 (23000)](#ex6)
  [Ошибки в .htaссess](#ex7)
  [Если в качестве WEB-сервера используется IIS](#ex8)
...
- Проблемы с использованием кодировки **UTF-8** на хостинге. Выясните, поддерживается ли она
  .
...
Проверьте, что ваш хостинг позволит организовать многосайтовость выбранным вами методом. Не все провайдеры позволяют корректно (для *Bitrix Framework*) создавать дополнительные сайты. Информацию об способах организации многосайтовости можно получить в главе [Многосайтовость](/learning/course/index.php?COURSE_ID=43&CHAPTER_ID=02704) курса «Разработчик Bitrix Framework».
