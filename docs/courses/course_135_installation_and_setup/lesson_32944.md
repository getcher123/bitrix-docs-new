...
- [← Предыдущий: 32926 — Конфигурация PostgreSQL](lesson_32926.md)
- [Следующий: 32928 — Конфигурация Push-server →](lesson_32928.md)

Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=135&LESSON_ID=32944
