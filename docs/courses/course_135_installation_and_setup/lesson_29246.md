...
- [Следующий: 2163 — Возможные ошибки при переносе сайта →](lesson_2163.md)

Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=135&LESSON_ID=29246
...
- настроенная виртуальная среда [BitrixVM](https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=37&LESSON_ID=29238&LESSON_PATH=3908.29228.29238) или [BitrixEnv](https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=37&LESSON_ID=29234&LESSON_PATH=3908.29228.29234)

После успешного создания, бекап сайта будет доступен на странице

			Список резервных копий

                    ![](../../../images/courses/135/dev.1c-bitrix.ru/images/portal_admin/install/vmbitrix/bx_move/vm_copy3_sm.png)
...
Воспользуйтесь командой
			...
			Получить ссылку для переноса
                    ...
                    ![](../../../images/courses/135/dev.1c-bitrix.ru/images/portal_admin/install/vmbitrix/bx_move/vm_copy4_sm.png)

		 в меню действий (ссылка доступна только для локально размещенной копии) и в появившемся окне скопируйте её в буфер обмена:

![](../../../images/courses/135/dev.1c-bitrix.ru/images/portal_admin/install/vmbitrix/bx_move/vm_copy5.png)
...
1. В адресной строке браузера введите http://адрес_виртуальной_машины/ (домен или ip-адрес из
  			**bitrix url**
                      ![](../../../images/courses/135/dev.1c-bitrix.ru/images/bitrixvm/vmbitrix7/start_vm/vmplayer5_1.png)
  		).
2. Откроется страница с описанием и ссылками на скачивание скриптов установки и восстановления:
  ![Нажмите на рисунок, чтобы увеличить](../../../images/courses/135/dev.1c-bitrix.ru/images/bitrixvm/vmbitrix9/install_product/bitrixvm_start_sm.png)
...
4. Вернитесь в браузер и допишите к адресу сайта restore.php. Например, адрес может выглядеть так: http://192.168.1.127/restore.php.
  ...
  ![Нажмите на рисунок, чтобы увеличить](../../../images/courses/135/dev.1c-bitrix.ru/images/bitrixvm/vmbitrix9/install_product/restore_start_sm.png)
5. На этапе загрузки резервной копии укажите место хранения архива сайта (в нашем примере — введите ссылку из буфера обмена, полученную на странице со списком резервных копий сайта):
  ![](../../../images/courses/135/dev.1c-bitrix.ru/images/admin_start/install/dump/new/dump_step2_3_sm_new.png)
...
6. Если архив был зашифрован —
  			введите пароль
                      ![](../../../images/courses/135/dev.1c-bitrix.ru/images/portal_admin/install/vmbitrix/bx_move/vm_copy8_sm.png)
  		 после скачивания.
7. Далее настройте подключение к базе данных:
  ![](../../../images/courses/135/dev.1c-bitrix.ru/images/portal_admin/install/vmbitrix/bx_move/vm_copy9_sm.png)
...
8. После успешного восстановления базы данных в целях безопасности, необходимо **Удалить локальную резервную копию и служебные скрипты**, нажав на
  			одноименную кнопку
                      ![](../../../images/courses/135/dev.1c-bitrix.ru/images/portal_admin/install/vmbitrix/bx_move/vm_copy10_sm.png)
  		.
9. Перенос продукта «1C-Битрикс» на виртуальную среду **BitrixVM/BitrixEnv** закончен.
  ![](../../../images/courses/135/dev.1c-bitrix.ru/images/portal_admin/install/vmbitrix/bx_move/vm_copy11_sm.png)
