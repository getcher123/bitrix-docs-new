...
- [← Предыдущий: 32634 — Конфигурация Redis](lesson_32634.md)
- [Следующий: 32638 — Конфигурация сайта →](lesson_32638.md)

Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=135&LESSON_ID=32636
...
11. Запустите сервис:
  ...
  ```
12. Выполните настройки Push-сервера, которые описаны [в следующем уроке](lesson_32638.md).
