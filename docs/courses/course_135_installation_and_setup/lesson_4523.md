...
Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=135&LESSON_ID=4523
...
- Откройте страницу http://&lt;ваш сайт&gt;/bitrixsetup.php в браузере, заменив строку &lt;ваш сайт&gt; на реальный адрес вашего сайта. В браузере отобразится страница загрузки дистрибутива.
  ![](../../../images/courses/135/dev.1c-bitrix.ru/images/admin_start/install/bitrixsetup/new/setup_master_1_sm.png)
...
- Нажмите кнопку **Загрузить**. Начнется
  			процесс загрузки и распаковки дистрибутива
                      ![](../../../images/courses/135/dev.1c-bitrix.ru/images/admin_start/install/bitrixsetup/new/setup_master_2_sm.png)
  		 на сайт.
