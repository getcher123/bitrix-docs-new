...
Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=135&LESSON_ID=2688
...
![Нажмите на рисунок, чтобы увеличить](../../../images/courses/135/dev.1c-bitrix.ru/images/admin_start/install/update/update_go_to_instal_sm.png)

Если на странице вывелось сообщение о том, что лицензионный ключ не верен (или лицензия не найдена), то установка не лицензирована и её  надо [зарегистрировать](/learning/course/index.php?COURSE_ID=135&CHAPTER_ID=04518).
...
![Нажмите на рисунок, чтобы увеличить](../../../images/courses/135/dev.1c-bitrix.ru/images/admin_start/install/update/error_wrong_code-sm.png)
...
![](../../../images/courses/135/dev.1c-bitrix.ru/images/admin_start/install/update/upd_wrong.png)
...
![](../../../images/courses/135/dev.1c-bitrix.ru/images/admin_start/install/update/massage_update.png)
