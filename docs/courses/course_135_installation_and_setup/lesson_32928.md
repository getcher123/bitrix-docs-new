...
- [← Предыдущий: 32944 — Конфигурация Redis](lesson_32944.md)
- [Следующий: 32946 — Конфигурация сайта →](lesson_32946.md)

Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=135&LESSON_ID=32928
...
5. Создайте пользователя `bitrix`.
  ```
...
10. Переконфигурируйте:
  ...
  ```
11. Запустите Push-сервис.
  ```
  systemctl --now enable push-server
  ```
12. Выполните настройки Push-сервера, описанные [в следующем уроке](lesson_32946.md).
