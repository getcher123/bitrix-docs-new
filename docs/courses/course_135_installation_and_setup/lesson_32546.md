...
- [← Предыдущий: 32494 — Конфигурация Nginx](lesson_32494.md)
- [Следующий: 32548 — Конфигурация Apache →](lesson_32548.md)

Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=135&LESSON_ID=32546

В АЛЬТ 10 хранилище PHP конфигурации расположено в папках:

- `/etc/php/8.2/cli/php.d/` — настройка CLI,
- `/etc/php/8.2/apache2-mod_php/php.d/` — настройки модуля Apache.
...
```
su -
rsync -av /opt/alt/php.d/ /etc/php/8.2/apache2-mod_php/php.d/
```
