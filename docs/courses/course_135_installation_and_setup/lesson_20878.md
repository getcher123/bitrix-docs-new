...
- [← Предыдущий: 20876 — Установка пакетов](lesson_20876.md)
- [Следующий: 20880 — Конфигурация PHP →](lesson_20880.md)

Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=135&LESSON_ID=20878
...
Все конфигурационные файлы можно [скачать в архиве](/docs/chm_files/sles15.zip). Конфигурационные файлы для Nginx расположены в папке: `sles15/nginx`.
