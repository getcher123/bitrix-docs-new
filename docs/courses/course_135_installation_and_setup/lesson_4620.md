...
Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=135&LESSON_ID=4620
...
[назад Конфигурация Push-server](lesson_2376.md)
		                                        [Настройка окружения для Astra 1.7 вперед](/learning/course/index.php?COURSE_ID=135&CHAPTER_ID=016782&LESSON_PATH=10495.4495.20866.30250.16782)
