...
- [← Предыдущий: 32786 — Конфигурация Redis](lesson_32786.md)
- [Следующий: 32790 — Конфигурация сайта →](lesson_32790.md)

Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=135&LESSON_ID=32788
...
11. Запустите сервис:
  ...
  ```
12. Выполните настройки Push-сервера, которые описаны [в следующем уроке](lesson_32790.md).
