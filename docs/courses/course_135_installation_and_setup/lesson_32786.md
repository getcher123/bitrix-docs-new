...
- [← Предыдущий: 32784 — Конфигурация PostgreSQL](lesson_32784.md)
- [Следующий: 32788 — Конфигурация Push-server →](lesson_32788.md)

Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=135&LESSON_ID=32786
