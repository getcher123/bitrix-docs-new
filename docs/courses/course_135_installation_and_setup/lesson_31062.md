...
- [← Предыдущий: 31060 — Конфигурация Push-server](lesson_31060.md)
- [Следующий: 31584 — Установка и настройка ОС →](lesson_31584.md)

Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=135&LESSON_ID=31062
...
Выполните [установку](https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=135&CHAPTER_ID=04888) продукта.
...
[назад Конфигурация Push-server](lesson_31060.md)
		                                        [Настройка окружения для Astra Linux 1.8 вперед](/learning/course/index.php?COURSE_ID=135&CHAPTER_ID=031580&LESSON_PATH=10495.4495.20866.31580)
