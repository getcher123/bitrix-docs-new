...
- [← Предыдущий: 32774 — Установка пакетов](lesson_32774.md)
- [Следующий: 32778 — Конфигурация PHP →](lesson_32778.md)

Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=135&LESSON_ID=32776
