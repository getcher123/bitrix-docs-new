...
- [← Предыдущий: 2618 — Третий шаг](lesson_2618.md)
- [Следующий: 2629 — Пятый шаг →](lesson_2629.md)

Официальная страница урока: https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=135&LESSON_ID=2626
...
Коробочная версия Битрикс24 поддерживает базы данных MySQL и PostgreSQL.
...
**Примечание**: Ручную установку параметров соединения с базой данных (в том числе и максимальный объем памяти для выполнения скрипта) вы можете выполнить в файлах `/bitrix/php_interface/dbconn.php` и `/bitrix/.settings.php` до версии 20.900.0, и только в файле `/bitrix/.settings.php` с версии 20.900.0. Файлы будут созданы после завершения установки.
