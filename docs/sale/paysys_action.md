...
**Примечание:**о работе с платежными системами в версиях старше 16.0.2 читайте в уроках курса **Разработчик Bitrix Framework**: - **Кастомизация платежных систем** - **Кастомизация шаблона платежной системы**
