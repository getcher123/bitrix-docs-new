...
| <Контрагент> | <Контрагенты> | Элемент содержит информацию о покупателе. Структура элемента такая же, как <Контрагенты> в файле контрагентов [contragents.xml](contragents.md). |
